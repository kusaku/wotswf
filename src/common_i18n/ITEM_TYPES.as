package
{
   public class ITEM_TYPES
   {
      ...
      public static const TANKMAN_SKILLS_BROTHERHOOD_FEMALE:String = "#item_types:tankman/skills/brotherhood_female";
      ...
      public static const MARKER_IGR:String = "#item_types:marker/igr";
      
      public static const TANKMAN_SKILLS_ENUM:Array = [TANKMAN_SKILLS_MAIN,TANKMAN_SKILLS_REPAIR,TANKMAN_SKILLS_REPAIR_DESCR,TANKMAN_SKILLS_FIRE_FIGHTING,TANKMAN_SKILLS_FIRE_FIGHTING_DESCR,TANKMAN_SKILLS_CAMOUFLAGE,TANKMAN_SKILLS_CAMOUFLAGE_DESCR,TANKMAN_SKILLS_BROTHERHOOD,TANKMAN_SKILLS_BROTHERHOOD_DESCR,TANKMAN_SKILLS_BROTHERHOOD_PERMANENT,TANKMAN_SKILLS_BROTHERHOOD_PERMANENT_DESCR,TANKMAN_SKILLS_BROTHERHOOD_FEMALE,TANKMAN_SKILLS_BROTHERHOOD_FEMALE_DESCR,TANKMAN_SKILLS_COMMANDER_TUTOR,TANKMAN_SKILLS_COMMANDER_TUTOR_DESCR,TANKMAN_SKILLS_COMMANDER_EXPERT,TANKMAN_SKILLS_COMMANDER_EXPERT_DESCR,TANKMAN_SKILLS_COMMANDER_UNIVERSALIST,TANKMAN_SKILLS_COMMANDER_UNIVERSALIST_DESCR,TANKMAN_SKILLS_COMMANDER_SIXTHSENSE,TANKMAN_SKILLS_COMMANDER_SIXTHSENSE_DESCR,TANKMAN_SKILLS_COMMANDER_EAGLEEYE,TANKMAN_SKILLS_COMMANDER_EAGLEEYE_DESCR,TANKMAN_SKILLS_DRIVER_TIDYPERSON,TANKMAN_SKILLS_DRIVER_TIDYPERSON_DESCR,TANKMAN_SKILLS_DRIVER_SMOOTHDRIVING,TANKMAN_SKILLS_DRIVER_SMOOTHDRIVING_DESCR,TANKMAN_SKILLS_DRIVER_VIRTUOSO,TANKMAN_SKILLS_DRIVER_VIRTUOSO_DESCR,TANKMAN_SKILLS_DRIVER_BADROADSKING,TANKMAN_SKILLS_DRIVER_BADROADSKING_DESCR,TANKMAN_SKILLS_DRIVER_RAMMINGMASTER,TANKMAN_SKILLS_DRIVER_RAMMINGMASTER_DESCR,TANKMAN_SKILLS_GUNNER_SMOOTHTURRET,TANKMAN_SKILLS_GUNNER_SMOOTHTURRET_DESCR,TANKMAN_SKILLS_GUNNER_GUNSMITH,TANKMAN_SKILLS_GUNNER_GUNSMITH_DESCR,TANKMAN_SKILLS_GUNNER_SNIPER,TANKMAN_SKILLS_GUNNER_SNIPER_DESCR,TANKMAN_SKILLS_GUNNER_WOODHUNTER,TANKMAN_SKILLS_GUNNER_WOODHUNTER_DESCR,TANKMAN_SKILLS_GUNNER_RANCOROUS,TANKMAN_SKILLS_GUNNER_RANCOROUS_DESCR,TANKMAN_SKILLS_LOADER_PEDANT,TANKMAN_SKILLS_LOADER_PEDANT_DESCR,TANKMAN_SKILLS_LOADER_DESPERADO,TANKMAN_SKILLS_LOADER_DESPERADO_DESCR,TANKMAN_SKILLS_LOADER_INTUITION,TANKMAN_SKILLS_LOADER_INTUITION_DESCR,TANKMAN_SKILLS_RADIOMAN_FINDER,TANKMAN_SKILLS_RADIOMAN_FINDER_DESCR,TANKMAN_SKILLS_RADIOMAN_INVENTOR,TANKMAN_SKILLS_RADIOMAN_INVENTOR_DESCR,TANKMAN_SKILLS_RADIOMAN_LASTEFFORT,TANKMAN_SKILLS_RADIOMAN_LASTEFFORT_DESCR,TANKMAN_SKILLS_RADIOMAN_RETRANSMITTER,TANKMAN_SKILLS_RADIOMAN_RETRANSMITTER_DESCR];
      ...
      public static const TANKMAN_ROLES_ENUM:Array = [TANKMAN_ROLES_COMMANDER,TANKMAN_ROLES_DRIVER,TANKMAN_ROLES_RADIOMAN,TANKMAN_ROLES_GUNNER,TANKMAN_ROLES_LOADER];
      ...
      public static function tankman_skills(param1:String) : String
      {
         var _loc2_:String = "#item_types:tankman/skills/" + param1;
         App.utils.asserter.assert(TANKMAN_SKILLS_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function tankman_roles(param1:String) : String
      {
         var _loc2_:String = "#item_types:tankman/roles/" + param1;
         App.utils.asserter.assert(TANKMAN_ROLES_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
   }
}
