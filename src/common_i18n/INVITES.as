package
{
   public class INVITES
   {
      ...
      public static const INVITES_TEXT_CLUBS:String = "#invites:invites/text/CLUBS";
      ...
      public static const INVITES_TEXT_CLUB:String = "#invites:invites/text/club";
      
      public static const INVITES_COMMENT_CLUB:String = "#invites:invites/comment/club";
      
      public static const INVITES_COMMENT_CLUB_DETAILS:String = "#invites:invites/comment/club/details";
      
      public static const CLUB_APPLICATIONS_TITLE:String = "#invites:club/applications/title";
      
      public static const CLUB_APPLICATIONS_COMMENT:String = "#invites:club/applications/comment";
      
      public static const CLUB_APPLICATIONS_BUTTONS_DETAILS:String = "#invites:club/applications/buttons/details";
      ...
      public static const CLUBS_STATE_ACTIVE:String = "#invites:clubs/state/ACTIVE";
      
      public static const CLUBS_STATE_ACCEPTED:String = "#invites:clubs/state/ACCEPTED";
      
      public static const CLUBS_STATE_DECLINED:String = "#invites:clubs/state/DECLINED";
      
      public static const CLUBS_STATE_CANCELLED:String = "#invites:clubs/state/CANCELLED";
