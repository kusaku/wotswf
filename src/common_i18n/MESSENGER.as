package
{
   public class MESSENGER
   {
      ...
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_ADD:String = "#messenger:contacts/searchView/tooltips/btns/add";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_CLOSE:String = "#messenger:contacts/searchView/tooltips/btns/close";
      ...
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_APPLY:String = "#messenger:contacts/createGroupView/tooltips/btns/apply";
      
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_CLOSE:String = "#messenger:contacts/createGroupView/tooltips/btns/close";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_APPLY:String = "#messenger:contacts/groupRenameView/tooltips/btns/apply";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_CLOSE:String = "#messenger:contacts/groupRenameView/tooltips/btns/close";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_APPLY:String = "#messenger:contacts/groupDeleteView/tooltips/btns/apply";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_CLOSE:String = "#messenger:contacts/groupDeleteView/tooltips/btns/close";
      ...
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_CLOSE:String = "#messenger:messenger/contacts/editNote/tooltips/btns/close";
      
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_OK:String = "#messenger:messenger/contacts/editNote/tooltips/btns/ok";
      
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_OK:String = "#messenger:messenger/contacts/createNote/tooltips/btns/ok";
      
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_CLOSE:String = "#messenger:messenger/contacts/createNote/tooltips/btns/close";
      ...
      public static const DIALOGS_CONTACTS_TREE_CLUB:String = "#messenger:dialogs/contacts/tree/club";
      ...
      public static const DIALOGS_SQUADCHANNEL_HEADERMSG_DYNSQUAD:String = "#messenger:dialogs/squadChannel/headerMsg/dynSquad";
      ...
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_REFSYSTEMQUESTS:String = "#messenger:serviceChannelMessages/battleResults/refSystemQuests";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_REFSYSTEMBOUGHTVEHICLE:String = "#messenger:serviceChannelMessages/battleResults/refSystemBoughtVehicle";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_REFSYSTEMCONTRIBUTEXP:String = "#messenger:serviceChannelMessages/battleResults/refSystemContributeXp";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_POTAPOVQUESTS:String = "#messenger:serviceChannelMessages/battleResults/potapovQuests";
      ...
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_CLUB_RATING_UP:String = "#messenger:serviceChannelMessages/battleResults/club/rating/up";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_CLUB_RATING_DOWN:String = "#messenger:serviceChannelMessages/battleResults/club/rating/down";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_CLUB_DIVISION_NEW:String = "#messenger:serviceChannelMessages/battleResults/club/division/new";
      
      public static const SERVICECHANNELMESSAGES_BATTLERESULTS_CLUB_LEAGUE_NEW:String = "#messenger:serviceChannelMessages/battleResults/club/league/new";
      ...
      public static const SERVICECHANNELMESSAGES_FORTIFICATIONSTARTUP_TITLE:String = "#messenger:serviceChannelMessages/fortificationStartUp/title";
      ...
      public static const PREBATTLE_ADDALLBTN_TOOLTIP_HEADER:String = PREBATTLE_ADDALLBTN_TOOLTIP + "/header";
      
      public static const PREBATTLE_ADDALLBTN_TOOLTIP_BODY:String = PREBATTLE_ADDALLBTN_TOOLTIP + "/body";
      
      public static const PREBATTLE_ADDBTN_TOOLTIP_HEADER:String = PREBATTLE_ADDBTN_TOOLTIP + "/header";
      
      public static const PREBATTLE_ADDBTN_TOOLTIP_BODY:String = PREBATTLE_ADDBTN_TOOLTIP + "/body";
      
      public static const PREBATTLE_REMOVEALLBTN_TOOLTIP_HEADER:String = PREBATTLE_REMOVEALLBTN_TOOLTIP + "/header";
      
      public static const PREBATTLE_REMOVEALLBTN_TOOLTIP_BODY:String = PREBATTLE_REMOVEALLBTN_TOOLTIP + "/body";
      
      public static const PREBATTLE_REMOVEBTN_TOOLTIP_HEADER:String = PREBATTLE_REMOVEBTN_TOOLTIP + "/header";
      
      public static const PREBATTLE_REMOVEBTN_TOOLTIP_BODY:String = PREBATTLE_REMOVEBTN_TOOLTIP + "/body";
      ...
      public static const SERVICECHANNELMESSAGES_FORT_PERMANENT_RESERVE_ACTIVATED:String = "#messenger:serviceChannelMessages/fort/PERMANENT_RESERVE_ACTIVATED";
      ...
      public static const CHAT_ACTION_BROADCAST_CLUB_MESSAGE:String = "#messenger:chat_action/BROADCAST_CLUB_MESSAGE";
      ...
      public static const MESSENGER_CONTACTS_MAINGROUPS_OTHER_REFERRALS:String = "#messenger:messenger/contacts/mainGroups/other/referrals";
      
      public static const MESSENGER_CONTACTS_MAINGROUPS_OTHER_REFERRERS:String = "#messenger:messenger/contacts/mainGroups/other/referrers";
      ...
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_CLOSE_HEADER:String = MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_CLOSE_BODY:String = MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_OK_HEADER:String = MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_OK + "/header";
      
      public static const MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_OK_BODY:String = MESSENGER_CONTACTS_CREATENOTE_TOOLTIPS_BTNS_OK + "/body";
      ...
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_CLOSE_HEADER:String = MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_CLOSE_BODY:String = MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_OK_HEADER:String = MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_OK + "/header";
      
      public static const MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_OK_BODY:String = MESSENGER_CONTACTS_EDITNOTE_TOOLTIPS_BTNS_OK + "/body";
      ...
      public static const CONTACTS_TOOLTIPS_BTNS_SEARCH_HEADER:String = CONTACTS_TOOLTIPS_BTNS_SEARCH + "/header";
      
      public static const CONTACTS_TOOLTIPS_BTNS_SEARCH_BODY:String = CONTACTS_TOOLTIPS_BTNS_SEARCH + "/body";
      
      public static const CONTACTS_TOOLTIPS_BTNS_ADDGROUP_HEADER:String = CONTACTS_TOOLTIPS_BTNS_ADDGROUP + "/header";
      
      public static const CONTACTS_TOOLTIPS_BTNS_ADDGROUP_BODY:String = CONTACTS_TOOLTIPS_BTNS_ADDGROUP + "/body";
      
      public static const CONTACTS_TOOLTIPS_BTNS_SETTINGS_HEADER:String = CONTACTS_TOOLTIPS_BTNS_SETTINGS + "/header";
      
      public static const CONTACTS_TOOLTIPS_BTNS_SETTINGS_BODY:String = CONTACTS_TOOLTIPS_BTNS_SETTINGS + "/body";
      
      public static const CONTACTS_TOOLTIPS_BTNS_EXTERNALSEARCH_HEADER:String = CONTACTS_TOOLTIPS_BTNS_EXTERNALSEARCH + "/header";
      
      public static const CONTACTS_TOOLTIPS_BTNS_EXTERNALSEARCH_BODY:String = CONTACTS_TOOLTIPS_BTNS_EXTERNALSEARCH + "/body";
      
      public static const CONTACTS_TOOLTIPS_SEARCHINPUT_CREDENTIALS:String = "#messenger:contacts/tooltips/searchInput/credentials";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_SEARCH_HEADER:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_SEARCH + "/header";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_SEARCH_BODY:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_SEARCH + "/body";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_ADD_HEADER:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_ADD + "/header";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_ADD_BODY:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_ADD + "/body";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_CLOSE_HEADER:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_CLOSE_BODY:String = CONTACTS_SEARCHVIEW_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_SEARCHDISABLED_BODY:String = CONTACTS_SEARCHVIEW_TOOLTIPS_SEARCHDISABLED + "/body";
      
      public static const CONTACTS_SEARCHVIEW_TOOLTIPS_SEARCHCREDENTIALS_BODY:String = CONTACTS_SEARCHVIEW_TOOLTIPS_SEARCHCREDENTIALS + "/body";
      
      public static const CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_APPLY_HEADER:String = CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_APPLY + "/header";
      
      public static const CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_APPLY_BODY:String = CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_APPLY + "/body";
      
      public static const CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_CLOSE_HEADER:String = CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_CLOSE_BODY:String = CONTACTS_SETTINGSVIEW_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const CONTACTS_MANAGEGROUPVIEW_TOOLTIPS_INPUT:String = "#messenger:contacts/manageGroupView/tooltips/input";
      
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_APPLY_HEADER:String = CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_APPLY + "/header";
      
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_APPLY_BODY:String = CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_APPLY + "/body";
      
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_CLOSE_HEADER:String = CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_CLOSE_BODY:String = CONTACTS_CREATEGROUPVIEW_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_APPLY_HEADER:String = CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_APPLY + "/header";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_APPLY_BODY:String = CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_APPLY + "/body";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_CLOSE_HEADER:String = CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_CLOSE_BODY:String = CONTACTS_GROUPRENAMEVIEW_TOOLTIPS_BTNS_CLOSE + "/body";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_APPLY_HEADER:String = CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_APPLY + "/header";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_APPLY_BODY:String = CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_APPLY + "/body";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_CLOSE_HEADER:String = CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_CLOSE + "/header";
      
      public static const CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_CLOSE_BODY:String = CONTACTS_GROUPDELETEVIEW_TOOLTIPS_BTNS_CLOSE + "/body";
      ...
      public static function client_error_contact(param1:String) : String
      {
         var _loc2_:String = "#messenger:client_error/contact/" + param1;
         if(CLIENT_ERROR_CONTACT_ENUM.indexOf(_loc2_) == -1)
         {
            DebugUtils.LOG_WARNING("[client_error_contact]:locale key \"" + _loc2_ + "\" was not found");
            return null;
         }
         return _loc2_;
      }
