package
{
   public class MENU
   {
      ...
      public static const TIME_TIMEVALUE:String = "#menu:Time/timeValue";
      
      public static const TIME_TIMEVALUESHORT:String = TIME_TIMEVALUE + "Short";
      
      public static const TRAINING_INFO_STATES_STATE:String = "#menu:training/info/states/state";
      
      public static const VEHICLEINFO_COMPAREBTN_TOOLTIP:String = "#menu:vehicleInfo/compareBtn/tooltip";
      ...
      public static const HANGAR_CREW_RODY_DOG_NAME:String = "#menu:hangar/crew/rody/dog/name";
      
      public static const HANGAR_CREW_RODY_DOG_MOREINFOLABEL:String = "#menu:hangar/crew/rody/dog/moreInfoLabel";
      
      public static const HANGAR_CREW_RODY_DOG_WINDOW_TITLE:String = "#menu:hangar/crew/rody/dog/window/title";
      
      public static const HANGAR_CREW_RODY_DOG_WINDOW_HEADER:String = "#menu:hangar/crew/rody/dog/window/header";
      
      public static const HANGAR_CREW_RODY_DOG_WINDOW_DESCRIPTION:String = "#menu:hangar/crew/rody/dog/window/description";
      
      public static const HANGAR_CREW_RODY_DOG_WINDOW_CLOSEBTNLABEL:String = "#menu:hangar/crew/rody/dog/window/closeBtnLabel";
      ...
      public static const TANKMANPERSONALCASE_MODIFIERS_CUSTOMIZATION:String = "#menu:tankmanPersonalCase/modifiers/customization";
      ...
      public static const TANKMANPERSONALCASE_CHANGEROLEBTN:String = "#menu:tankmanPersonalCase/changeRoleBtn";
      ...
      public static const TANKMSNPERSONALCASE_LOADINGINFO:String = "#menu:tankmsnPersonalCase/loadingInfo";
      ...
      public static const HEADERBUTTONS_BTNLABEL_INSQUAD:String = "#menu:headerButtons/btnLabel/inSquad";
      
      public static const HEADERBUTTONS_BTNLABEL_CREATESQUAD:String = "#menu:headerButtons/btnLabel/createSquad";
      ...
      public static const HEADERBUTTONS_BTNLABEL_BUY_GOLD:String = "#menu:headerButtons/btnLabel/buy_gold";
      
      public static const HEADERBUTTONS_BTNLABEL_EXCHANGE_GOLD:String = "#menu:headerButtons/btnLabel/exchange_gold";
      
      public static const HEADERBUTTONS_BTNLABEL_GATHERING_EXPERIENCE:String = "#menu:headerButtons/btnLabel/gathering_experience";
      ...
      public static const HEADERBUTTONS_ENCYCLOPEDIA:String = "#menu:headerButtons/encyclopedia";
      ...
      public static const HEADER_ACCOUNT_POPOVER_CLAN_NOTINCLAN:String = "#menu:header/account/popover/clan/notInClan";
      ...
      public static const HEADER_ACCOUNT_POPOVER_REFERRAL_INVITED:String = "#menu:header/account/popover/referral/invited";
      
      public static const HEADER_ACCOUNT_POPOVER_REFERRAL_MOREINFO:String = "#menu:header/account/popover/referral/moreInfo";
      ...
      public static const PREMIUM_BONUS1:String = "#menu:premium/bonus1";
      ...
      public static const PREMIUM_BONUS2:String = "#menu:premium/bonus2";
      ...
      public static const VEHICLEINFO_PARAMS_DAMAGEAVGPERMINUTE:String = "#menu:vehicleInfo/params/damageAvgPerMinute";
      ...
      public static const VEHICLEINFO_COMPAREBTN_TOOLTIP_HEADER:String = VEHICLEINFO_COMPAREBTN_TOOLTIP + "/header";
      
      public static const VEHICLEINFO_COMPAREBTN_TOOLTIP_BODY:String = VEHICLEINFO_COMPAREBTN_TOOLTIP + "/body";
      ...
      public static const RESEARCH_PREMIUM_BENEFITS_PREMIUMVEHICLEFIRST:String = "#menu:research/premium/benefits/premiumVehicleFirst";
      
      public static const RESEARCH_PREMIUM_BENEFITS_PREMIUMVEHICLESECOND:String = "#menu:research/premium/benefits/premiumVehicleSecond";
      ...
      public static const RESEARCH_SHOWINPREVIEWBTN_LABEL:String = "#menu:research/showInPreviewBtn/label";
      ...
      public static const BARRACKS_OBTAININGVEHICLETYPE_DROPDOWNITEM_BUYINGVEHICLE:String = "#menu:barracks/obtainingVehicleType/dropDownItem/buyingVehicle";
      
      public static const BARRACKS_OBTAININGVEHICLETYPE_DROPDOWNITEM_RESTOREVEHICLE:String = "#menu:barracks/obtainingVehicleType/dropDownItem/restoreVehicle";
      ...
      public static const SKILLDROPWINDOW_STUDY_ACADEMY:String = "#menu:skillDropWindow/study/academy";
      
      public static const SKILLDROPWINDOW_STUDY_SCOOL:String = "#menu:skillDropWindow/study/scool";
      
      public static const SKILLDROPWINDOW_STUDY_FREE:String = "#menu:skillDropWindow/study/free";
      ...
      public static const SKILLDROPWINDOW_FREEDROPLABEL:String = "#menu:skillDropWindow/freeDropLabel";
      
      public static const SKILLDROPWINDOW_FREEDROPPERCENT:String = "#menu:skillDropWindow/freeDropPercent";
      ...
      public static const AWARDWINDOW_QUESTS_TOKENS_HEADER:String = "#menu:awardWindow/quests/tokens/header";
      
      public static const AWARDWINDOW_QUESTS_TOKENS_DESCRIPTION:String = "#menu:awardWindow/quests/tokens/description";
      
      public static const AWARDWINDOW_QUESTS_MEDALS_HEADER:String = "#menu:awardWindow/quests/medals/header";
      
      public static const AWARDWINDOW_QUESTS_TANKMANFEMALE_HEADER:String = "#menu:awardWindow/quests/tankmanFemale/header";
      
      public static const AWARDWINDOW_QUESTS_TANKMANFEMALE_DESCRIPTION:String = "#menu:awardWindow/quests/tankmanFemale/description";
      ...
      public static const AWARDWINDOW_REFERRAL_TANKMAN_HEADER:String = "#menu:awardWindow/referral/tankman/header";
      
      public static const AWARDWINDOW_REFERRAL_TANKMAN_DESCRIPTION_NORMAL:String = "#menu:awardWindow/referral/tankman/description/normal";
      
      public static const AWARDWINDOW_REFERRAL_TANKMAN_DESCRIPTION_NOXP:String = "#menu:awardWindow/referral/tankman/description/noXp";
      
      public static const AWARDWINDOW_REFERRAL_VEHICLE_HEADER:String = "#menu:awardWindow/referral/vehicle/header";
      
      public static const AWARDWINDOW_REFERRAL_VEHICLE_DESCRIPTION_NORMAL:String = "#menu:awardWindow/referral/vehicle/description/normal";
      
      public static const AWARDWINDOW_REFERRAL_VEHICLE_DESCRIPTION_NOXP:String = "#menu:awardWindow/referral/vehicle/description/noXp";
      
      public static const AWARDWINDOW_REFERRAL_VEHICLE_DESCRIPTION_BOUGHT:String = "#menu:awardWindow/referral/vehicle/description/bought";
      
      public static const AWARDWINDOW_REFERRAL_NEXTTANKMAN:String = "#menu:awardWindow/referral/nextTankman";
      
      public static const AWARDWINDOW_REFERRAL_COMPLETE:String = "#menu:awardWindow/referral/complete";
      
      public static const AWARDWINDOW_REFERRAL_CREDITS_HEADER:String = "#menu:awardWindow/referral/credits/header";
      
      public static const AWARDWINDOW_REFERRAL_CREDITS_DESCRIPTION:String = "#menu:awardWindow/referral/credits/description";
      ...
      public static const AWARDWINDOW_TELECOMAWARD_HEADER:String = "#menu:awardWindow/telecomAward/header";
      
      public static const AWARDWINDOW_TELECOMAWARD_DESCRIPTION:String = "#menu:awardWindow/telecomAward/description";
      
      public static const AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHBROTHERHOOD:String = "#menu:awardWindow/telecomAward/description/withBrotherhood";
      
      public static const AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHOUTCREW:String = "#menu:awardWindow/telecomAward/description/withoutCrew";
      
      public static const AWARDWINDOW_TELECOMAWARD_DESCRIPTION_PREM:String = "#menu:awardWindow/telecomAward/description/prem";
      
      public static const AWARDWINDOW_TELECOMAWARD_VEHICLES:String = "#menu:awardWindow/telecomAward/vehicles";
      
      public static const AWARDWINDOW_TELECOMAWARD_SUBDESCRIPTION:String = "#menu:awardWindow/telecomAward/subdescription";
      
      public static const AWARDWINDOW_TELECOMAWARD_BUTTON_LABEL:String = "#menu:awardWindow/telecomAward/button/label";
      ...
      public static const REFERRALMANAGEMENTWINDOW_TITLE:String = "#menu:ReferralManagementWindow/title";
      
      public static const REFERRALMANAGEMENTWINDOW_INFOHEADER_HAVENOTTANK:String = "#menu:ReferralManagementWindow/infoHeader/haveNotTank";
      
      public static const REFERRALMANAGEMENTWINDOW_INFOHEADER_HAVETANK:String = "#menu:ReferralManagementWindow/infoHeader/haveTank";
      
      public static const REFERRALMANAGEMENTWINDOW_DESCRIPTION:String = "#menu:ReferralManagementWindow/description";
      
      public static const REFERRALMANAGEMENTWINDOW_INVITEDPLAYERS:String = "#menu:ReferralManagementWindow/invitedPlayers";
      
      public static const REFERRALMANAGEMENTWINDOW_INVITEMANAGEMENTLINK:String = "#menu:ReferralManagementWindow/inviteManagementLink";
      
      public static const REFERRALMANAGEMENTWINDOW_CLOSEBTNLABEL:String = "#menu:ReferralManagementWindow/closeBtnLabel";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_NICK:String = "#menu:ReferralManagementWindow/referralsTable/nick";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_EXP:String = "#menu:ReferralManagementWindow/referralsTable/exp";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_EXPMULTIPLIER:String = "#menu:ReferralManagementWindow/referralsTable/expMultiplier";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_LEFTTIME:String = "#menu:ReferralManagementWindow/referralsTable/leftTime";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_LEFTHOURS:String = "#menu:ReferralManagementWindow/referralsTable/leftHours";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_LEFTDAYS:String = "#menu:ReferralManagementWindow/referralsTable/leftDays";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_CREATESQUADBTN_LABEL:String = "#menu:ReferralManagementWindow/referralsTable/createSquadBtn/label";
      
      public static const REFERRALMANAGEMENTWINDOW_REFERRALSTABLE_EMPTYLINE:String = "#menu:ReferralManagementWindow/referralsTable/emptyLine";
      
      public static const REFERRALMANAGEMENTWINDOW_PROGRESSINDICATOR_PROGRESS:String = "#menu:ReferralManagementWindow/progressIndicator/progress";
      
      public static const REFERRALMANAGEMENTWINDOW_PROGRESSINDICATOR_COMPLETE:String = "#menu:ReferralManagementWindow/progressIndicator/complete";
      
      public static const REFERRALMANAGEMENTWINDOW_PROGRESSNOTAVAILABLE:String = "#menu:ReferralManagementWindow/progressNotAvailable";
      
      public static const REFERRALREFERRERINTROWINDOW_WINDOWTITLE:String = "#menu:ReferralReferrerIntroWindow/windowTitle";
      
      public static const REFERRALREFERRERINTROWINDOW_APPLYBUTTON_LABEL:String = "#menu:ReferralReferrerIntroWindow/applyButton/label";
      
      public static const REFERRALREFERRERINTROWINDOW_TITLEMESSAGE:String = "#menu:ReferralReferrerIntroWindow/titleMessage";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_TITLE_INVITE_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_title/invite_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_BODY_INVITE_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_body/invite_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_TITLE_SQUAD_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_title/squad_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_BODY_SQUAD_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_body/squad_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_TITLE_REFERRALS_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_title/referrals_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_BODY_REFERRALS_BLOCK:String = "#menu:ReferralReferrerIntroWindow/textBlock_body/referrals_block";
      
      public static const REFERRALREFERRERINTROWINDOW_TEXTBLOCK_LINK:String = "#menu:ReferralReferrerIntroWindow/textBlock_link";
      
      public static const REFERRALREFERRALSINTROWINDOW_TEXT_BLOCK_TITLE:String = "#menu:ReferralReferralsIntroWindow/text_block/title";
      
      public static const REFERRALREFERRALSINTROWINDOW_TEXT_BLOCK_BODY_REFERRALS:String = "#menu:ReferralReferralsIntroWindow/text_block/body/referrals";
      
      public static const REFERRALREFERRALSINTROWINDOW_TEXT_BLOCK_BODY_PHENIX:String = "#menu:ReferralReferralsIntroWindow/text_block/body/phenix";
      
      public static const REFERRALREFERRALSINTROWINDOW_TEXT_BLOCK_SQUAD_TEXT:String = "#menu:ReferralReferralsIntroWindow/text_block/squad_text";
      ...
      public static const TIME_TIMEVALUE_DAYS:String = TIME_TIMEVALUE + "/days";
      
      public static const TIME_TIMEVALUE_HOURS:String = TIME_TIMEVALUE + "/hours";
      
      public static const TIME_TIMEVALUE_MIN:String = TIME_TIMEVALUE + "/min";
      
      public static const TIME_TIMEVALUE_LESSMIN:String = TIME_TIMEVALUE + "/lessMin";
      
      public static const TIME_TIMEVALUESHORT_DAYS:String = TIME_TIMEVALUE + "Short/days";
      
      public static const TIME_TIMEVALUESHORT_HOURS:String = TIME_TIMEVALUE + "Short/hours";
      
      public static const TIME_TIMEVALUESHORT_MIN:String = TIME_TIMEVALUE + "Short/min";
      
      public static const TIME_TIMEVALUESHORT_LESSMIN:String = TIME_TIMEVALUE + "Short/lessMin";
      ...
      public static const STATICFORAMTION_STAFF_CTXMENU_PASSOWNERSHIP:String = "#menu:staticForamtion/staff/ctxMenu/passOwnership";
      
      public static const STATICFORAMTION_STAFF_CTXMENU_REMOVEMEMBER:String = "#menu:staticForamtion/staff/ctxMenu/removeMember";
      ...
      public static const BOOSTERSWINDOW_BOOSTERSTABLERENDERER_HEADER:String = "#menu:boostersWindow/boostersTableRenderer/header";
      ...
      public static const NATION_TREE_TITLE_ENUM:Array = [NATION_TREE_TITLE_USSR,NATION_TREE_TITLE_GERMANY,NATION_TREE_TITLE_USA,NATION_TREE_TITLE_FRANCE,NATION_TREE_TITLE_UK,NATION_TREE_TITLE_CHINA,NATION_TREE_TITLE_JAPAN,NATION_TREE_TITLE_CZECH,NATION_TREE_TITLE_SWEDEN];
      ...
      public static const TANK_PARAMS_ENUM:Array = [TANK_PARAMS_MAXHEALTH,TANK_PARAMS_VEHICLEWEIGHT,TANK_PARAMS_ENGINEPOWER,TANK_PARAMS_ENGINEPOWERPERTON,TANK_PARAMS_SPEEDLIMITS,TANK_PARAMS_CHASSISROTATIONSPEED,TANK_PARAMS_HULLARMOR,TANK_PARAMS_FACEFRONTBOARDINMM,TANK_PARAMS_TURRETARMOR,TANK_PARAMS_RELOADTIME,TANK_PARAMS_RELOADTIMESECS,TANK_PARAMS_PIERCINGPOWER,TANK_PARAMS_DAMAGE,TANK_PARAMS_DAMAGEAVG,TANK_PARAMS_DAMAGEAVGPERMINUTE,TANK_PARAMS_TURRETROTATIONSPEED,TANK_PARAMS_GUNROTATIONSPEED,TANK_PARAMS_CIRCULARVISIONRADIUS,TANK_PARAMS_RADIODISTANCE,TANK_PARAMS_TURRETYAWLIMITS,TANK_PARAMS_PITCHLIMITS,TANK_PARAMS_GUNYAWLIMITS,TANK_PARAMS_CLIPFIRERATE,TANK_PARAMS_RELATIVEPOWER,TANK_PARAMS_RELATIVEARMOR,TANK_PARAMS_RELATIVEMOBILITY,TANK_PARAMS_RELATIVEVISIBILITY,TANK_PARAMS_RELATIVECAMOUFLAGE,TANK_PARAMS_PARAM12,TANK_PARAMS_SHOTDISPERSIONANGLE,TANK_PARAMS_AIMINGTIME,TANK_PARAMS_MAXAMMO,TANK_PARAMS_INVISIBILITYSTILLFACTOR,TANK_PARAMS_INVISIBILITYMOVINGFACTOR,TANK_PARAMS_VALUES_PARAM12_VALUE0,TANK_PARAMS_VALUES_PARAM12_VALUE1,TANK_PARAMS_VALUES_PARAM12_VALUE2,TANK_PARAMS_VALUES_PARAM12_VALUE3,TANK_PARAMS_VALUES_PARAM10_VALUE0,TANK_PARAMS_VALUES_PARAM10_VALUE1,TANK_PARAMS_VALUES_PARAM10_VALUE2,TANK_PARAMS_VALUES_PARAM10_VALUE3,TANK_PARAMS_VALUES_PARAM11_VALUE0,TANK_PARAMS_VALUES_PARAM11_VALUE1,TANK_PARAMS_VALUES_PARAM11_VALUE2,TANK_PARAMS_VALUES_PARAM11_VALUE3,TANK_PARAMS_EXPLOSIONRADIUS,TANK_PARAMS_T,TANK_PARAMS_P,TANK_PARAMS_PT,TANK_PARAMS_MPH,TANK_PARAMS_GPS,TANK_PARAMS_SPM,TANK_PARAMS_S,TANK_PARAMS_MM,TANK_PARAMS_VAL,TANK_PARAMS_VPM,TANK_PARAMS_M,TANK_PARAMS_H,TANK_PARAMS_SQM,TANK_PARAMS_CNT,TANK_PARAMS_GRADS,TANK_PARAMS_PERCENT,TANK_PARAMS_KG,TANK_PARAMS_CLIPSEC];
      
      public static const VEHPARAMS_ENUM:Array = [VEHPARAMS_FIREPOWER,VEHPARAMS_ARMOR,VEHPARAMS_MOBILITY,VEHPARAMS_RECONNAISSANCE];
      ...
      public static const MODULEINFO_PARAMS_ENUM:Array = [MODULEINFO_PARAMS_MAXLOAD,MODULEINFO_PARAMS_BOMBSNUMBERRANGE,MODULEINFO_PARAMS_AREASQUARE,MODULEINFO_PARAMS_FLYDELAYRANGE,MODULEINFO_PARAMS_BOMBDAMAGE,MODULEINFO_PARAMS_SHOTSNUMBERRANGE,MODULEINFO_PARAMS_AREARADIUS,MODULEINFO_PARAMS_ARTDELAYRANGE,MODULEINFO_PARAMS_LEVEL_LBL,MODULEINFO_PARAMS_ENGINEPOWER,MODULEINFO_PARAMS_CALIBER,MODULEINFO_PARAMS_SHELLSCOUNT,MODULEINFO_PARAMS_SHELLRELOADINGTIME,MODULEINFO_PARAMS_RELOADMAGAZINETIME,MODULEINFO_PARAMS_RELOADTIME,MODULEINFO_PARAMS_PIERCINGPOWER,MODULEINFO_PARAMS_DAMAGE,MODULEINFO_PARAMS_AVGPIERCINGPOWER,MODULEINFO_PARAMS_AVGDAMAGE,MODULEINFO_PARAMS_AVGDAMAGEPERMINUTE,MODULEINFO_PARAMS_ARMOR,MODULEINFO_PARAMS_ROTATIONSPEED,MODULEINFO_PARAMS_DISPERTIONRADIUS,MODULEINFO_PARAMS_AIMINGTIME,MODULEINFO_PARAMS_FIRESTARTINGCHANCE,MODULEINFO_PARAMS_RADIODISTANCE,MODULEINFO_PARAMS_CIRCULARVISIONRADIUS,MODULEINFO_PARAMS_WEIGHT,MODULEINFO_PARAMS_EXPLOSIONRADIUS,MODULEINFO_PARAMS_PIERCINGDISTANCEHEADER,MODULEINFO_PARAMS_PIERCINGDISTANCE,MODULEINFO_PARAMS_MAXSHOTDISTANCE,MODULEINFO_PARAMS_MAXSHOTDISTANCE_FOOTNOTE,MODULEINFO_PARAMS_NOPIERCINGDISTANCE_FOOTNOTE,MODULEINFO_PARAMS_NOPIERCINGDISTANCE_FOOTNOTE_MAXDISTANCE];
      ...
      public static const LOADING_BATTLETYPES_DESC_ENUM:Array = [LOADING_BATTLETYPES_DESC_0,LOADING_BATTLETYPES_DESC_1,LOADING_BATTLETYPES_DESC_2,LOADING_BATTLETYPES_DESC_3,LOADING_BATTLETYPES_DESC_4,LOADING_BATTLETYPES_DESC_5,LOADING_BATTLETYPES_DESC_6,LOADING_BATTLETYPES_DESC_7,LOADING_BATTLETYPES_DESC_8,LOADING_BATTLETYPES_DESC_9,LOADING_BATTLETYPES_DESC_10,LOADING_BATTLETYPES_DESC_11,LOADING_BATTLETYPES_DESC_12,LOADING_BATTLETYPES_DESC_13,LOADING_BATTLETYPES_DESC_14];
      ...
      public static const VEHICLEINFO_PARAMS_ENUM:Array = [VEHICLEINFO_PARAMS_MAXHEALTH,VEHICLEINFO_PARAMS_VEHICLEWEIGHT,VEHICLEINFO_PARAMS_ENGINEPOWER,VEHICLEINFO_PARAMS_SPEEDLIMITS,VEHICLEINFO_PARAMS_CHASSISROTATIONSPEED,VEHICLEINFO_PARAMS_HULLARMOR,VEHICLEINFO_PARAMS_TURRETARMOR,VEHICLEINFO_PARAMS_RELOADTIME,VEHICLEINFO_PARAMS_PIERCINGPOWER,VEHICLEINFO_PARAMS_DAMAGE,VEHICLEINFO_PARAMS_TURRETROTATIONSPEED,VEHICLEINFO_PARAMS_GUNROTATIONSPEED,VEHICLEINFO_PARAMS_CIRCULARVISIONRADIUS,VEHICLEINFO_PARAMS_RADIODISTANCE,VEHICLEINFO_PARAMS_PITCHLIMITS,VEHICLEINFO_PARAMS_GUNYAWLIMITS,VEHICLEINFO_PARAMS_AIMINGTIME,VEHICLEINFO_PARAMS_SHOTDISPERSIONANGLE,VEHICLEINFO_PARAMS_DAMAGEAVGPERMINUTE,VEHICLEINFO_PARAMS_ENGINEPOWERPERTON,VEHICLEINFO_PARAMS_CLIPFIRERATE,VEHICLEINFO_PARAMS_TURRETYAWLIMITS,VEHICLEINFO_PARAMS_INVISIBILITY,VEHICLEINFO_PARAMS_INVISIBILITYSTILLFACTOR,VEHICLEINFO_PARAMS_INVISIBILITYMOVINGFACTOR,VEHICLEINFO_PARAMS_RELOADTIMESECS];
      
      public static const DENUNCIATION_ENUM:Array = [DENUNCIATION_1,DENUNCIATION_2,DENUNCIATION_3,DENUNCIATION_7];
      
      public static const HEADER_ACCOUNT_POPOVER_CLAN_POSITION_ENUM:Array = [HEADER_ACCOUNT_POPOVER_CLAN_POSITION_LEADER,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_VICE_LEADER,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_RECRUITER,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_TREASURER,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_DIPLOMAT,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_COMMANDER,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_PRIVATE,HEADER_ACCOUNT_POPOVER_CLAN_POSITION_RECRUIT];
      ...
      public static function tank_params(param1:String) : String
      {
         ...
         if(TANK_PARAMS_ENUM.indexOf(_loc2_) == -1)
         {
            DebugUtils.LOG_WARNING("[tank_params]:locale key \"" + _loc2_ + "\" was not found");
            return null;
         }
         return _loc2_;
      }
      
      public static function vehparams(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:vehParams/" + param1;
         if(VEHPARAMS_ENUM.indexOf(_loc2_) == -1)
         {
            DebugUtils.LOG_WARNING("[vehparams]:locale key \"" + _loc2_ + "\" was not found");
            return null;
         }
         return _loc2_;
      }
      ...
      public static function referralreferrerintrowindow_textblock_title(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:ReferralReferrerIntroWindow/textBlock_title/" + param1;
         App.utils.asserter.assert(REFERRALREFERRERINTROWINDOW_TEXTBLOCK_TITLE_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function header_account_popover_stats(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:header/account/popover/stats/" + param1;
         App.utils.asserter.assert(HEADER_ACCOUNT_POPOVER_STATS_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function header_account_popover_crew_position(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:header/account/popover/crew/position/" + param1;
         App.utils.asserter.assert(HEADER_ACCOUNT_POPOVER_CREW_POSITION_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function referralreferrerintrowindow_textblock_body(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:ReferralReferrerIntroWindow/textBlock_body/" + param1;
         App.utils.asserter.assert(REFERRALREFERRERINTROWINDOW_TEXTBLOCK_BODY_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      
      public static function barracks_obtainingvehicletype_dropdownitem(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:barracks/obtainingVehicleType/dropDownItem/" + param1;
         App.utils.asserter.assert(BARRACKS_OBTAININGVEHICLETYPE_DROPDOWNITEM_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function finalstatistic_commonstats_resultlabel(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:finalStatistic/commonStats/resultlabel/" + param1;
         App.utils.asserter.assert(FINALSTATISTIC_COMMONSTATS_RESULTLABEL_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function header_account_popover_clan_position(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:header/account/popover/clan/position/" + param1;
         App.utils.asserter.assert(HEADER_ACCOUNT_POPOVER_CLAN_POSITION_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
      ...
      public static function referralreferralsintrowindow_text_block_body(param1:String) : String
      {
         var _loc2_:String = null;
         _loc2_ = "#menu:ReferralReferralsIntroWindow/text_block/body/" + param1;
         App.utils.asserter.assert(REFERRALREFERRALSINTROWINDOW_TEXT_BLOCK_BODY_ENUM.indexOf(_loc2_) != -1,"locale key \"" + _loc2_ + "\" was not found");
         return _loc2_;
      }
