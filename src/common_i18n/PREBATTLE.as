package
{
   public class PREBATTLE
   {
      ...
      public static const BUTTONS_COMPANY_CREATE:String = "#prebattle:buttons/company/create";
      
      public static const LABELS_COMPANY_DIVISION_ALL:String = "#prebattle:labels/company/division/ALL";
      
      public static const LABELS_COMPANY_DIVISION_JUNIOR:String = "#prebattle:labels/company/division/JUNIOR";
      
      public static const LABELS_COMPANY_DIVISION_MIDDLE:String = "#prebattle:labels/company/division/MIDDLE";
      
      public static const LABELS_COMPANY_DIVISION_CHAMPION:String = "#prebattle:labels/company/division/CHAMPION";
      
      public static const LABELS_COMPANY_DIVISION_ABSOLUTE:String = "#prebattle:labels/company/division/ABSOLUTE";
      
      public static const LABELS_COMPANY_DIVISION_NA:String = "#prebattle:labels/company/division/NA";
      
      public static const LABELS_COMPANY_LIMITS:String = "#prebattle:labels/company/limits";
      
      public static const LABELS_COMPANY_NOTINBATTLE:String = "#prebattle:labels/company/notInBattle";
      
      public static const LABELS_COMPANY_ISOPEN:String = "#prebattle:labels/company/isOpen";
      
      public static const LABELS_COMPANY_DEFAULTCOMMENT:String = "#prebattle:labels/company/defaultComment";
      
      public static const LABELS_COMPANY_DEFAULTTEXT:String = "#prebattle:labels/company/defaultText";
      
      public static const LABELS_COMPANY_PLAYERS_TOP:String = "#prebattle:labels/company/players/top";
      
      public static const LABELS_COMPANY_PLAYERS_BOTTOM:String = "#prebattle:labels/company/players/bottom";
      
      public static const LABELS_COMPANY_STATS_COUNT:String = "#prebattle:labels/company/stats/count";
      
      public static const LABELS_COMPANY_QUEUE:String = "#prebattle:labels/company/queue";
      
      public static const SWITCHPERIPHERYWINDOW_COMPANY_HEADER:String = "#prebattle:switchPeripheryWindow/company/header";
      
      public static const SWITCHPERIPHERYWINDOW_COMPANY_DESCRIPTION:String = "#prebattle:switchPeripheryWindow/company/description";
      
      public static const SWITCHPERIPHERYWINDOW_COMPANY_SELECTSERVERLABEL:String = "#prebattle:switchPeripheryWindow/company/selectServerLabel";
      
      public static const SWITCHPERIPHERYWINDOW_COMPANY_APPLYSWITCHLABEL:String = "#prebattle:switchPeripheryWindow/company/applySwitchLabel";
