...
public class DropdownMenu extends Button {
    ...
    protected function showDropdown():void {
        ...
        if (this.dropdown is String && this.dropdown != "") {
            _loc2_ = App.utils.classFactory.getClass(this.dropdown.toString());
            if (_loc2_ != null) {
                _loc1_ = App.utils.classFactory.getComponent(this.dropdown.toString(), CoreList) as CoreList;
            }
        }
        if (_loc1_) {
            if (this.itemRenderer is String && this.itemRenderer != "") {
                _loc1_.itemRenderer = App.utils.classFactory.getClass(this.itemRenderer.toString());
            }
            ...
            if (this.scrollBar is String && this.scrollBar != "") {
                _loc1_.scrollBar = App.utils.classFactory.getClass(this.scrollBar.toString());
            }
