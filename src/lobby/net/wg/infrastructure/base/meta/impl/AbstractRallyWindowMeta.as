...
public class AbstractRallyWindowMeta extends PrebattleChannelCarouselItem {
    ...
    public var onBrowseStaticsRallies:Function;
    ...
    public function onBrowseStaticsRalliesS():void {
        App.utils.asserter.assertNotNull(this.onBrowseStaticsRallies, "onBrowseStaticsRallies" + Errors.CANT_NULL);
        this.onBrowseStaticsRallies();
    }
