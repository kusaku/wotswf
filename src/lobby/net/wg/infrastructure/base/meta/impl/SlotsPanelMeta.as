...
public class SlotsPanelMeta extends BaseDAAPIComponent {
    ...
    public final function as_setSlots(param1:Array):void {
        ...
        var _loc4_:int = 0;
        while (_loc4_ < _loc3_) {
            this._vectorSlotVO[_loc4_] = this.getSlotVO(param1[_loc4_]);
            _loc4_++;
        }
    ...
    public final function as_updateSlot(param1:Object):void {
        this.updateSlot(this.getSlotVO1(param1));
    }
    ...
    protected function getSlotVO(param1:Object):SlotVO {
        var _loc2_:String = "getSlotVO" + Errors.ABSTRACT_INVOKE;
        DebugUtils.LOG_ERROR(_loc2_);
        throw new AbstractException(_loc2_);
    }
    ...
    protected function getSlotVO1(param1:Object):SlotVO {
        var _loc2_:String = "getSlotVO1" + Errors.ABSTRACT_INVOKE;
        DebugUtils.LOG_ERROR(_loc2_);
        throw new AbstractException(_loc2_);
    }
