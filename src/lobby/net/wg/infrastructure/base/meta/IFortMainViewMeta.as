...
public interface IFortMainViewMeta extends IEventDispatcher {
    ...
    function onClanProfileClickS():void;
    ...
    function onSelectOrderSelectorS(param1:Boolean):void;
    ...
    function as_setTutorialArrowVisibility(param1:String, param2:Boolean):void;
}
}
