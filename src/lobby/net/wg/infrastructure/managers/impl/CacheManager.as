...
public class CacheManager extends CacheManagerMeta implements ICacheManager {
    ...
    public function getTotalSize():int {
        ...
        var _loc3_:int = 0;
        while (_loc3_ < _loc2_) {
            _loc1_ = _loc1_ + this.cachedEntities[_loc3_].size;
            _loc3_++;
        }
        return _loc1_;
    }
...
class CacheSettings {
    ...
    public function toString():String {
        var _loc1_:* = "";
        _loc1_ = _loc1_ + ("\tenabled:\t" + String(this.enabled));
...
class CacheEntity {
    ...
    private function getSize(param1:Loader):int {
        var _loc2_:int = param1.contentLoaderInfo.bytesLoaded;
        return _loc2_;
    }
    ...
    public function toString():String {
        ...
        var _loc2_:String = "URL: " + this.url + ", priority: " + String(this.priority) + ", size: " + String(this.size) + ", class: " + (!!this.classDef ? this.classDef.toString() : "None") + ", created: " + String(_loc1_.getHours()) + ":" + String(_loc1_.getMinutes()) + ":" + String(_loc1_.getSeconds()) + "." + String(_loc1_.getMilliseconds());
        return _loc2_;
    }
...
class CacheStats {
    ...
    public function getEntity(param1:CacheEntity):void {
        var _loc2_:* = "\n" + LOG_ID;
        _loc2_ = _loc2_ + " Get entity from cache: \n";
        _loc2_ = _loc2_ + ("\t\t" + param1.toString());
        this.snapshots.push(_loc2_);
    }
    ...
    public function addSnapshot(param1:Vector.<CacheEntity>):void {
        ...
        var _loc4_:int = 0;
        while (_loc4_ < _loc3_) {
            _loc2_ = _loc2_ + ("\t\t" + param1[_loc4_].toString() + "\n");
            _loc4_++;
        }
    ...
    public function logSettings():void {
        ...
        if (this.cacheManager.settings) {
            ...
            _loc1_ = _loc1_ + this.cacheManager.settings.toString();
    ...
    public function logSnapshots():void {
        ...
        if (_loc2_ > 0) {
            _loc3_ = 0;
            while (_loc3_ < _loc2_) {
                _loc1_ = _loc1_ + this.snapshots[_loc3_];
                _loc3_++;
            }
        }
        else {
            _loc1_ = _loc1_ + (LOG_ID + " The cache is empty.");
        }
        DebugUtils.LOG_DEBUG(_loc1_);
    }
