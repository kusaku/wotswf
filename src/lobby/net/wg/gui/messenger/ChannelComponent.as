...
public class ChannelComponent extends ChannelComponentMeta implements IChannelComponent {
    ...
    override protected function onPopulate():void {
        ...
        var _loc1_:String = getLastUnsentMessageS();
        if (_loc1_ != Values.EMPTY_STR) {
            this.messageInput.text = _loc1_;
        }
    ...
    override protected function onBeforeDispose():void {
        ...
        if (this.messageInput.text != Values.EMPTY_STR) {
            setLastUnsentMessageS(this.messageInput.text);
        }
