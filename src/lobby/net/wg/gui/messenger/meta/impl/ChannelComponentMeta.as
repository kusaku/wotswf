...
public class ChannelComponentMeta extends BaseDAAPIComponent {
    ...
    public var getLastUnsentMessage:Function;

    public var setLastUnsentMessage:Function;
    ...
    public function getLastUnsentMessageS():String {
        App.utils.asserter.assertNotNull(this.getLastUnsentMessage, "getLastUnsentMessage" + Errors.CANT_NULL);
        return this.getLastUnsentMessage();
    }

    public function setLastUnsentMessageS(param1:String):void {
        App.utils.asserter.assertNotNull(this.setLastUnsentMessage, "setLastUnsentMessage" + Errors.CANT_NULL);
        this.setLastUnsentMessage(param1);
    }
}
}
