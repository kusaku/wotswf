...
public class ContactsListGroupVO extends TreeContentVO {
    ...
    public function get rules():int {
        return !!this._rules ? int(this._rules.getBitMask()) : 0;
    }
    ...
    override public function get isResizable():Boolean {
        return !!this._rules ? Boolean(this._rules.isResizable()) : false;
    }

    public function get isDropAllowed():Boolean {
        return !!this._rules ? Boolean(this._rules.isDropAllowed()) : false;
    }

    public function get canBeManaged():Boolean {
        return !!this._rules ? Boolean(this._rules.canBeManaged()) : false;
    }
}
}
