...
public class ContactScrollingList extends BaseContactsScrollingList implements IDropList {
    ...
    override protected function onDispose():void {
        ...
        App.gameInputMgr.clearKeyHandler(Keyboard.CONTROL, KeyboardEvent.KEY_DOWN);
        App.gameInputMgr.clearKeyHandler(Keyboard.CONTROL, KeyboardEvent.KEY_UP);
        if (this.highlight) {
