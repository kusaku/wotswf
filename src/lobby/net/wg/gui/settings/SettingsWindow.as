...
import net.wg.gui.settings.vo.SettingsKeyProp;
...
public class SettingsWindow extends SettingsWindowMeta implements ISettingsWindowMeta {
    ...
    override protected function configUI():void {
        ...
        addEventListener(SettingViewEvent.ON_CONTROL_CHANGED, this.onControlChangedHandler);
        addEventListener(SettingViewEvent.ON_PTT_CONTROL_CHANGED, this.onPTTControlChangedHandler);
        addEventListener(SettingViewEvent.ON_AUTO_DETECT_QUALITY, this.onAutodetectQualityHandler);
        addEventListener(SettingViewEvent.ON_VIVOX_TEST, this.onVivoxTestHandler);
        addEventListener(SettingViewEvent.ON_UPDATE_CAPTURE_DEVICE, this.onUpdateCaptureDevicesHandler);
        addEventListener(AlternativeVoiceEvent.ON_TEST_ALTERNATIVE_VOICES, this.onAlternativeVoiceHandler);
    ...
    override protected function onDispose():void {
        ...
        removeEventListener(SettingViewEvent.ON_PTT_CONTROL_CHANGED, this.onPTTControlChangedHandler);
        removeEventListener(SettingViewEvent.ON_CONTROL_CHANGED, this.onControlChangedHandler);
        removeEventListener(SettingViewEvent.ON_AUTO_DETECT_QUALITY, this.onAutodetectQualityHandler);
        removeEventListener(SettingViewEvent.ON_VIVOX_TEST, this.onVivoxTestHandler);
        removeEventListener(SettingViewEvent.ON_UPDATE_CAPTURE_DEVICE, this.onUpdateCaptureDevicesHandler);
        removeEventListener(AlternativeVoiceEvent.ON_TEST_ALTERNATIVE_VOICES, this.onAlternativeVoiceHandler);
    ...
    public function as_confirmWarningDialog(param1:Boolean, param2:String):void {
        ...
        if (param1) {
            if (param2.indexOf(SOUND_MODE_WARNING, 0) >= 0) {
                _loc3_ = SettingsConfigHelper.instance.settingsData[SettingsConfigHelper.SOUND_SETTINGS];
                _loc4_ = SettingsControlProp(_loc3_["alternativeVoices"]);
                _loc4_.current = 0;
                _loc5_ = SoundSettings(this.tryGetView(SettingsConfigHelper.SOUND_SETTINGS));
    ...
    public function as_isPresetApplied():Boolean {
        ...
        var _loc1_:GraphicSettings = GraphicSettings(this.tryGetView(SettingsConfigHelper.GRAPHIC_SETTINGS));
        if (_loc1_) {
            _loc2_ = _loc1_.graphicsQualityDropDown;
            _loc3_ = _loc2_.dataProvider.requestItemAt(_loc2_.selectedIndex)["data"];
    ...
    public function as_onVibroManagerConnect(param1:Boolean):void {
        SettingsControlProp(SettingsConfigHelper.instance.settingsData.getByKey(SettingsConfigHelper.OTHER_SETTINGS).vibroIsConnected).current = param1;
    ...
    public function as_setCaptureDevices(param1:Number, param2:Array):void {
        var _loc3_:SoundSettings = SoundSettings(this.tryGetView(SettingsConfigHelper.SOUND_SETTINGS));
        if (_loc3_ != null) {
    ...
    public function as_setGraphicsPreset(param1:Number):void {
        ...
        var _loc2_:GraphicSettings = GraphicSettings(this.tryGetView(SettingsConfigHelper.GRAPHIC_SETTINGS));
        if (_loc2_) {
    ...
    public function as_updateVideoSettings(param1:Object):void {
        var _loc4_:SettingsConfigHelper = null;
        var _loc5_:uint = 0;
        var _loc6_:IDataUtils = null;
        var _loc7_:uint = 0;
        ...
        if (param1) {
            _loc4_ = SettingsConfigHelper.instance;
            _loc5_ = _loc4_.liveUpdateVideoSettingsOrderData.length;
            _loc6_ = App.utils.data;
            _loc7_ = 0;
            while (_loc7_ < _loc5_) {
                _loc2_ = false;
                _loc8_ = _loc4_.liveUpdateVideoSettingsOrderData[_loc7_];
                _loc9_ = new SettingsControlProp();
                if (param1[_loc8_] != null) {
                    if (param1[_loc8_] is Boolean || param1[_loc8_] is String || param1[_loc8_] is Number) {
                        _loc9_.current = param1[_loc8_];
                        _loc2_ = true;
                    }
                    else {
                        if (param1[_loc8_].current is Object && param1[_loc8_].current != undefined) {
                            _loc9_.current = param1[_loc8_].real != null ? param1[_loc8_].real : param1[_loc8_].current;
                        }
                        if (param1[_loc8_].options != undefined) {
                            _loc9_.options = _loc6_.cloneObject(param1[_loc8_].options);
                            _loc2_ = true;
                        }
                        else {
                            _loc9_.options = [];
                ...
                else if (_loc8_ == SettingsConfigHelper.DYNAMIC_RENDERER) {
                    _loc10_ = _loc4_.liveUpdateVideoSettingsData[_loc8_];
                    if (_loc10_ != null) {
                        _loc10_.dispose();
                    }
                    delete _loc4_.liveUpdateVideoSettingsData[_loc8_];
                }
                if (_loc2_) {
                    _loc4_.liveUpdateVideoSettingsData[_loc8_] = _loc9_;
                }
                _loc7_++;
            }
        }
        var _loc3_:GraphicSettings = GraphicSettings(this.tryGetView(SettingsConfigHelper.GRAPHIC_SETTINGS));
        if (_loc3_) {
    ...
    private function invalidateAllTabs():void {
        ...
        this._invalidTabs = {};
        var _loc1_:Array = SettingsConfigHelper.instance.tabsDataProviderWithOther;
    ...
    private function initializeCommonData(param1:SettingsDataVo):void {
        ...
        if (this.tabs != null) {
            ...
            _loc2_ = SettingsConfigHelper.instance.tabsDataProviderWithOther[_currentTab].linkage;
    ...
    private function updateTabs(param1:Boolean):void {
        ...
        var _loc3_:uint = 0;
        if (param1) {
            _loc2_ = new DataProvider(SettingsConfigHelper.instance.tabsDataProviderWithOther);
            this.tabs.dataProvider = _loc2_;
        }
        else {
            _loc2_ = new DataProvider(SettingsConfigHelper.instance.tabsDataProvider);
            this.tabs.dataProvider = _loc2_;
        }
    ...
    private function controlDefValEqNewVal(param1:*, param2:*):Boolean {
        ...
        if (!(param2 is String) && !(param2 is Number) && !(param2 is Boolean)) {
            for (_loc4_ in param2) {
                _loc3_ = param1.getByKey(_loc4_);
                if (_loc3_ != null) {
                    if (_loc3_ is SettingsControlProp) {
                        return SettingsControlProp(_loc3_).current == param2[_loc4_];
                    }
                    if (_loc3_ is SettingsKeyProp) {
                        return SettingsKeyProp(_loc3_).key == param2[_loc4_];
                    }
                    return this.controlDefValEqNewVal(_loc3_, param2[_loc4_]);
                }
            }
        }
        return false;
    ...
    private function normalize(param1:SettingsDataVo):SettingsDataVo {
        ...
        var _loc2_:SettingsDataVo = SettingsConfigHelper.instance.settingsData;
        ...
        while (_loc6_ < _loc5_) {
            if (_loc4_[_loc6_] != undefined) {
                this.normalizeInside(_loc4_[_loc6_] as SettingsDataVo, _loc2_[_loc3_[_loc6_]]);
            }
            _loc6_++;
        }
    ...
    private function normalizeInside(param1:SettingsDataVo, param2:SettingsDataVo):void {
        ...
        var _loc13_:* = null;
        var _loc14_:SettingsDataVo = null;
        ...
        while (_loc6_ < _loc3_) {
            ...
            if (_loc5_ != undefined) {
                if (_loc4_ == SettingsConfigHelper.PRESETS) {
                    param2[_loc4_] = new SettingsDataVo(_loc7_.cloneObject(_loc5_));
                }
                else if (_loc4_ == SettingsConfigHelper.QUALITY_ORDER) {
                    if (_loc5_ is Array) {
                ...
                else if (_loc4_ == SettingsConfigHelper.COLOR_FILTER_IMAGES) {
                    _loc10_ = [];
                    for (_loc11_ in _loc5_) {
                        _loc10_[int(_loc11_)] = _loc5_[_loc11_];
                    }
                    param2[_loc4_] = Vector.<String>(_loc10_);
                }
                else if (_loc4_ == SettingsConfigHelper.KEYBOARD_IMPORTANT_BINDS) {
                    param2[_loc4_] = Vector.<String>(_loc5_);
                }
                else if (_loc4_ == SettingsConfigHelper.KEYBOARD) {
                ...
                else if (param2[_loc4_] is SettingsControlProp) {
                    _loc12_ = SettingsControlProp(param2[_loc4_]);
                    if (_loc5_ is Boolean || _loc5_ is String || _loc5_ is Number) {
                        _loc12_.current = _loc12_.type == SettingsConfigHelper.TYPE_CHECKBOX ? Boolean(_loc5_) : _loc5_;
                        _loc12_.prevVal = _loc12_.current;
                    }
                    else if (_loc5_ is Array) {
                        if (_loc12_.type == SettingsConfigHelper.TYPE_RANGE_SLIDER) {
                            _loc12_.current = _loc5_;
                        }
                    }
                    else if (_loc5_ is Object && _loc5_.current != undefined) {
                        if (_loc12_.type == SettingsConfigHelper.TYPE_CHECKBOX) {
                            _loc12_.current = Boolean(_loc5_.current);
                            _loc12_.prevVal = _loc12_.current;
                            if (param2 is ControlsSettingsDataVo) {
                                this.tryToSetDefault(_loc5_, _loc12_);
                            }
                            if (_loc5_.hasOwnProperty(SettingsControlProp.OPTIONS_LBL)) {
                                _loc12_.options = _loc7_.cloneObject(_loc5_.options);
                                for (_loc13_ in _loc5_.options) {
                                    if (_loc5_.options[_loc13_].hasOwnProperty(SettingsControlProp.ADVANCED_LBL) && _loc5_.options[_loc13_].advanced == true) {
                                        _loc12_.advanced = true;
                                        break;
                                    }
                                }
                            }
                            if (_loc5_.hasOwnProperty(SettingsControlProp.EXTRA_DATA_LBL)) {
                                _loc12_.extraData = _loc7_.cloneObject(_loc5_.extraData);
                            }
                        }
                        else {
                            _loc12_.current = Math.max(_loc5_.current, 0);
                            _loc12_.prevVal = _loc12_.current;
                            if (param2 is ControlsSettingsDataVo) {
                                this.tryToSetDefault(_loc5_, _loc12_);
                            }
                            if (_loc5_.options != undefined) {
                                _loc12_.options = _loc7_.cloneObject(_loc5_.options);
                            }
                            else {
                                _loc12_.options = [];
                ...
                else if (param2[_loc4_] != undefined) {
                    _loc14_ = new SettingsDataVo(_loc5_);
                    App.utils.data.cleanupDynamicObject(_loc5_);
                    this.normalizeInside(_loc14_, param2[_loc4_]);
                    _loc14_.dispose();
                }
            }
            _loc6_++;
    ...
    private function normalizeKeys(param1:Object, param2:Array, param3:SettingsDataVo, param4:Vector.<String>):void {
        ...
        while (_loc6_ < _loc5_) {
            ...
            param4.push(_loc7_);
            param3.keys.push(_loc7_);
            param3.values.push(new SettingsKeyProp(_loc7_, true, _loc7_, null, NaN, NaN, null, false, _loc6_ == 0 ? Number(0) : Number(MAX_RENDERER_Y_OFFSET)));
            _loc10_ = 0;
            while (_loc10_ < _loc9_) {
                ...
                if (param1[_loc11_].current != null) {
                    ...
                    _loc16_ = true;
                    param4.push(_loc11_);
                    param3.keys.push(_loc11_);
                    param3.values.push(new SettingsKeyProp(_loc11_, false, _loc11_, _loc12_, _loc14_, _loc15_, _loc13_, _loc16_));
                }
                _loc10_++;
            }
            _loc6_++;
    ...
    private function sendData(param1:Boolean):void {
        ...
        var _loc2_:SoundSettings = SoundSettings(this.tryGetView(SettingsConfigHelper.SOUND_SETTINGS));
        if (_loc2_) {
        ...
        if (_loc3_ || _loc4_) {
            _loc5_ = !!_loc3_ ? CONTROLS_WARNING : "";
            _loc5_ = _loc5_ + (!!_loc4_ ? SOUND_MODE_WARNING : "");
            showWarningDialogS(_loc5_, this._changesData.getChanges(), param1);
        }
        else {
            _loc6_ = GraphicSettings(this.tryGetView(SettingsConfigHelper.GRAPHIC_SETTINGS));
            if (_loc6_) {
    ...
    private function checkControlsWrong():Boolean {
        ...
        _loc2_ = SettingsConfigHelper.instance.settingsData[SettingsConfigHelper.CONTROLS_SETTINGS][SettingsConfigHelper.KEYBOARD];
        for (_loc3_ in _loc2_) {
            _loc4_ = SettingsKeyProp(_loc2_[_loc3_]);
            if (_loc4_.key == KeyProps.KEY_NONE) {
                return true;
            }
        }
        return false;
    ...
    private function updateSettingsConfig(param1:Boolean):void {
        ...
        if (param1 && this._changesData) {
            ...
            this.searchAndOverride(SettingsConfigHelper.instance.settingsData, _loc2_);
            this._changesData.clear();
        }
    ...
    private function searchAndOverride(param1:SettingsDataVo, param2:Object):void {
        ...
        for (_loc5_ in param2) {
            ...
            _loc3_ = this.getControlInLayer(param1, _loc5_);
            if (_loc4_ is Boolean || _loc4_ is Number || _loc4_ is String) {
                ...
                _loc6_ = SettingsDataVo(_loc3_);
                if (_loc6_ != null) {
                    this.searchAndOverride(_loc6_, _loc4_);
                }
            }
        }
    }
    ...
    private function onTabIndexChangeHandler(param1:IndexEvent):void {
        ...
        onTabSelectedS(SettingsConfigHelper.instance.tabsDataProviderWithOther[_currentTab].label);
    }
    ...
    private function onViewChangeHandler(param1:ViewStackEvent):void {
        ...
        if (_loc3_ is GraphicSettings) {
            ...
            if (this._graphicsPresetToSelect != -1) {
                (_loc3_ as GraphicSettings).setPresetAfterAutoDetect(this._graphicsPresetToSelect);
                this._graphicsPresetToSelect = -1;
            }
        }
        else {
    ...
    private function onPTTControlChangedHandler(param1:SettingViewEvent):void {
        var _loc2_:SettingsControlProp = SettingsControlProp(SettingsConfigHelper.instance.settingsData[SettingsConfigHelper.SOUND_SETTINGS][SettingsConfigHelper.PTT]);
    ...
    private function onControlChangedHandler(param1:SettingViewEvent):void {
    ...
    private function onVivoxTestHandler(param1:SettingViewEvent):void {
        var _loc2_:Boolean = Boolean(param1.controlValue);
        var _loc3_:Boolean = startVOIPTestS(_loc2_);
        var _loc4_:SoundSettings = SoundSettings(this.tryGetView(SettingsConfigHelper.SOUND_SETTINGS));
        if (_loc4_ != null) {
            _loc4_.setVoiceTestState(!(_loc3_ || !_loc2_));
        }
    }

    private function onAutodetectQualityHandler(param1:SettingViewEvent):void {
    ...
    private function onUpdateCaptureDevicesHandler(param1:SettingViewEvent):void {
        updateCaptureDevicesS();
    }

    private function onAlternativeVoiceHandler(param1:AlternativeVoiceEvent):void {
        ...
        if (isSoundModeValidS()) {
            ...
            _loc2_ = SoundSettings(this.tryGetView(SettingsConfigHelper.SOUND_SETTINGS));
