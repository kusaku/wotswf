...
public class BaseRallySlotHelper extends SlotRendererHelper {
    ...
    override public function updateComponents(param1:IRallySimpleSlotRenderer, param2:IRallySlotVO):void {
        ...
        if (param2) {
            _loc5_ = !!param2.player ? Boolean(UserTags.isCurrentPlayer(param2.player.tags)) : false;
            ...
            if (!param2.isClosed) {
                ...
                if (param2.selectedVehicle) {
                    ...
                    _loc3_.vehicleBtn.vehicleCount = _loc3_.index == 0 || !param2.hasRestrictions ? -1 : int(param2.compatibleVehiclesCount);
