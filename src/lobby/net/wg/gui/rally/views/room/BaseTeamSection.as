...
public class BaseTeamSection extends UIComponentEx implements IBaseTeamSection {
    ...
    public function enableFightButton(param1:Boolean):void {
        ...
        if (this.btnFight) {
            this.btnFight.enabled = param1 && (!!this._actionButtonData ? Boolean(this._actionButtonData.isEnabled) : true);
        }
        if (this.btnNotReady) {
            this.btnNotReady.enabled = param1 && (!!this._actionButtonData ? Boolean(this._actionButtonData.isEnabled) : true);
        }
    }
