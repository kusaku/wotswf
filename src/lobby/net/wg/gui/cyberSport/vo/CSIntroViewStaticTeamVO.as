...
public class CSIntroViewStaticTeamVO extends DAAPIDataClass {
    ...
    override public function isEquals(param1:DAAPIDataClass):Boolean {
        ...
        return this.clubId == _loc2_.clubId && this.ladderIconSource == _loc2_.ladderIconSource && this.isLadderBtnEnabled == _loc2_.isLadderBtnEnabled && this.clockIconSource == _loc2_.clockIconSource && this.isClockIconVisible == _loc2_.isClockIconVisible && this.teamHeaderText == _loc2_.teamHeaderText && this.isRequestWaitingTextVisible == _loc2_.isRequestWaitingTextVisible && this.requestWaitingText == _loc2_.requestWaitingText && this.isTeamDescriptionBackVisible == _loc2_.isTeamDescriptionBackVisible && this.teamDescriptionText == _loc2_.teamDescriptionText && this.isTeamDescriptionTooltip == _loc2_.isTeamDescriptionTooltip && this.teamDescriptionTooltip == _loc2_.teamDescriptionTooltip && this.createBtnLabel == _loc2_.createBtnLabel && this.createBtnTooltip == _loc2_.createBtnTooltip && this.isCreateBtnEnabled == _loc2_.isCreateBtnEnabled && this.isCreateBtnVisible == _loc2_.isCreateBtnVisible && this.teamAdditionalBtnLabel == _loc2_.teamAdditionalBtnLabel && this.teamAdditionalBtnTooltip == _loc2_.teamAdditionalBtnTooltip && this.isTeamAdditionalBtnVisible == _loc2_.isTeamAdditionalBtnVisible && this.cancelBtnLabel == _loc2_.cancelBtnLabel && this.cancelBtnTooltip == _loc2_.cancelBtnTooltip && this.isCancelBtnVisible == _loc2_.isCancelBtnVisible && this.isNeedAddPlayers == _loc2_.isNeedAddPlayers && this.isCanCreateBattle == _loc2_.isCanCreateBattle && this.isHaveTeamToShow == _loc2_.isHaveTeamToShow && this.isCanJoinBattle == _loc2_.isCanJoinBattle;
    }
}
}
