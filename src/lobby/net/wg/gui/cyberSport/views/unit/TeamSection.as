...
public class TeamSection extends CyberSportTeamSectionBase {
    ...
    override protected function configUI():void {
        super.configUI();
        lblTeamHeader.autoSize = TextFieldAutoSize.LEFT;
    ...
    override protected function updateComponents():void {
        ...
        var _loc1_:Boolean = !!unitData ? Boolean(unitData.isCommander) : false;
    ...
    private function updateSettingsIcon():void {
        if (unitData && !unitData.isCommander) {
            ...
            this.settingsIcons.flakeVisible = !!unitData ? Boolean(unitData.isFreezed) : false;
            this.settingsIcons.gearVisible = !!unitData ? Boolean(unitData.hasRestrictions) : false;
        }
        else {
