...
public class RangeRosterSettingsView extends UIComponentEx implements IViewStackContent {
    ...
    private static const FLAGS_SOURCE:String = "../maps/icons/filters/nations/";

    private static const PNG_TYPE:String = ".png";
    ...
    override protected function configUI():void {
        ...
        this._flagsButtons.push(this.flag1, this.flag2, this.flag3, this.flag4, this.flag5, this.flag6, this.flag7, this.flag8, this.flag9);
    ...
    private function updateNationFlags(param1:Vector.<BlackButton>):void {
        ...
        while (_loc5_ < _loc2_) {
            ...
            _loc4_.iconSource = FLAGS_SOURCE + _loc3_ + PNG_TYPE;
            _loc4_.data = _loc3_;
            _loc5_++;
        }
    }
