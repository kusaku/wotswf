...
public class TeamMemberRendererBase extends SoundListItemRenderer {
    ...
    override protected function updateAfterStateChange():void {
        ...
        var _loc1_:Number = !!this.model ? Number(this.model.getCurrentColor()) : Number(Number.NaN);
        if (!isNaN(_loc1_)) {
    ...
    protected function updateVoiceWave():void {
        this.voiceWave.visible = App.voiceChatMgr.isVOIPEnabledS();
        this.voiceWave.setMuted(!!this.model ? Boolean(UserTags.isMuted(this.model.tags)) : false);
    }
