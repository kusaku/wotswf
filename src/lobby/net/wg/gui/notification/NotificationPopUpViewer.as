    ...
    override protected function draw():void {
        ...
        if ((this._arrangeLayout || this._isMessagesCountInvalid) && this._stageDimensions) {
            ...
            while (this._pendingForDisplay.length > 0 && _loc6_) {
                ...
                _loc1_.data = _loc5_;
                _loc8_ = _loc5_.messageVO.timestamp;
                if (_loc8_ != Values.DEFAULT_INT) {
                    _loc5_.messageVO.timestampStr = getMessageActualTimeS(_loc8_);
                }
                _loc1_.validateNow();
            ...
            if (_loc6_) {
                _loc9_ = this._displayingNowPopUps.length;
                _loc10_ = _loc7_;
