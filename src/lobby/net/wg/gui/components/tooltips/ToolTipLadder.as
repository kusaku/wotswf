...
public class ToolTipLadder extends ToolTipSpecial {
    ...
    override protected function redraw():void {
        ...
        topPosition = topPosition + (this.headerTF.height + Utils.instance.MARGIN_AFTER_BLOCK | 0);
        ...
        topPosition = topPosition + (Utils.instance.MARGIN_AFTER_SEPARATE | 0);
        this.icon.autoSize = false;
        this.icon.source = _loc3_.icon;
        this.icon.x = _loc4_;
        this.icon.y = topPosition - ICO_TOP_SHIFT | 0;
        topPosition = topPosition + (ICO_DIMENSION - ICO_TOP_SHIFT - ICO_BOTTOM_SHIFT + Utils.instance.MARGIN_AFTER_BLOCK | 0);
        ...
        if (StringUtils.isNotEmpty(_loc3_.state)) {
            ...
            topPosition = topPosition + (this.stateTF.height | 0);
        ...
        if (StringUtils.isNotEmpty(_loc3_.points)) {
            ...
            topPosition = topPosition + (this.pointsTF.height | 0);
            _loc2_ = Math.max(_loc2_, this.pointsTF.width + _loc5_);
        }
        else {
            this.pointsTF.visible = false;
        }
        topPosition = topPosition + (Utils.instance.MARGIN_AFTER_BLOCK | 0);
        ...
        if (StringUtils.isNotEmpty(_loc3_.status)) {
            ...
            topPosition = topPosition + (this.statusTF.height + Utils.instance.MARGIN_AFTER_SEPARATE | 0);
        ...
        if (_loc7_) {
            ...
            topPosition = topPosition + (this.seasonTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
        }
        else {
