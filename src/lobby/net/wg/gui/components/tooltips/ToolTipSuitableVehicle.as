...
public class ToolTipSuitableVehicle extends ToolTipSpecial {
    ...
    override protected function redraw():void {
        ...
        if (!_loc2_.isCreator) {
            ...
            this.headerTF.htmlText = Utils.instance.htmlWrapper(_loc1_.makeString(_loc2_.toolTipType == TOOLTIPS_CONSTANTS.CYBER_SPORT_SLOT ? TOOLTIPS.SUITABLEVEHICLE_CONDITIONSTITLE : TOOLTIPS.CSAUTOSEARCHVEHICLE_CONDITIONSTITLE), Utils.instance.COLOR_HEADER, 18, "$TitleFont");
        }
        ...
        if (!_loc2_.isCreator && _loc2_.vehiclesList && _loc2_.vehiclesList.length > 0) {
            ...
            topPosition = topPosition + Utils.instance.MARGIN_AFTER_SEPARATE;
            _loc6_ = Utils.instance.addHeader("suitableHeader", contentMargin.left + bgShadowMargin.left, topPosition, _loc1_.makeString(_loc2_.toolTipType == TOOLTIPS_CONSTANTS.CYBER_SPORT_SLOT ? TOOLTIPS.SUITABLEVEHICLE_SUITABLETITLE : TOOLTIPS.CSAUTOSEARCHVEHICLE_SUITABLETITLE));
    ...
    private function addSuitableVehicleBlockItem(param1:MovieClip, param2:VehicleVO, param3:Number):Number {
        ...
        param3 = param3 + (_loc4_.height + this.MARGIN_BEETWEEN_BLOCKS);
        return param3;
    }
}
}
