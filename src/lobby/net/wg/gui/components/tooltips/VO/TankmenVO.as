...
public class TankmenVO {
    ...
    private function parsHash(param1:Object):void {
        ...
        this.isCurrentVehiclePremium = param1.hasOwnProperty("isCurrentVehiclePremium") && param1["isCurrentVehiclePremium"] != undefined ? Boolean(param1["isCurrentVehiclePremium"]) : false;
