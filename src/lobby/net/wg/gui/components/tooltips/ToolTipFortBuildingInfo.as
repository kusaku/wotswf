...
public class ToolTipFortBuildingInfo extends ToolTipSpecial {
    ...
    private static const INFO_MSG_BOTTOM_PADDING_BIG:int = 25;

    private static const INFO_MSG_BOTTOM_PADDING_SMALL:int = 5;

    public var buildingIcon:PopoverBuildingTexture;
    ...
    public function ToolTipFortBuildingInfo() {
        ...
        this.buildingName.autoSize = TextFieldAutoSize.LEFT;
