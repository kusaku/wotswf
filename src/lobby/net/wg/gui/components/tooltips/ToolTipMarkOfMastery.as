...
public class ToolTipMarkOfMastery extends ToolTipSpecial {
    ...
    override protected function redraw():void {
        ...
        var _loc6_:* = _loc5_.makeString(ACHIEVEMENTS.MARKOFMASTERYCONTENT + "/" + _loc1_.localizedValue) + "%";
        ...
        _loc7_ = _loc7_ + ("<br/><br/>" + Utils.instance.htmlWrapper(_loc8_, Utils.instance.COLOR_SUB_NORMAL, 12, "$TextFont"));
        ...
        while (_loc11_ > 0) {
            ...
            _loc10_.leftText = _loc10_.leftText + (this.utils.htmlWrapper(_loc13_, this.utils.COLOR_NUMBER, 11, "$TextFont") + "<br>");
        ...
        if (_loc1_.oldRecordOn != Values.EMPTY_STR && _loc1_.oldRecordLevel != Values.EMPTY_STR) {
            ...
            topPosition = topPosition + (this.recordTF.height + this.utils.MARGIN_AFTER_LASTITEM | 0);
        }
        else {
