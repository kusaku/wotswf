...
public class ToolTipColumnFields extends ToolTipBase {
    ...
    override protected function redraw():void {
        ...
        while (_loc6_ < _loc1_.columns.length) {
            ...
            _loc5_ = _loc5_ + this.setTextFieldProps(_loc2_, _loc3_, _loc4_);
            content.addChild(_loc2_);
            this._columns.push(_loc2_);
            _loc6_++;
        }
        _loc5_ = _loc5_ + (this._columns.length - 1) * BETWEEN_COLUMN_MARGIN;
    ...
    protected function updatePositions():void {
        ...
        if (this._columns) {
            topPosition = topPosition + (this.headerTF.height + HEADER_BOTTOM_MARGIN);
            _loc2_ = _loc1_;
            _loc3_ = null;
            _loc4_ = 0;
            while (_loc4_ < this._columns.length) {
                ...
                _loc3_.x = _loc2_;
                _loc2_ = _loc2_ + (_loc3_.width + BETWEEN_COLUMN_MARGIN ^ 0);
                _loc4_++;
            }
        }
    }
