...
public class ToolTipBuySkill extends ToolTipBase {
    ...
    private function getContDimension():Dimension {
        ...
        _loc1_.height = !!this.skillLevel ? Number(this.skillLevel.y + this.skillLevel.height + SKILL_LEVEL_HEIGHT_SHIFT | 0) : !!this.skillCount ? Number(this.skillCount.y + this.skillCount.height + SKILL_LEVEL_HEIGHT_SHIFT | 0) : Number(_loc1_.height);
        return _loc1_;
    }
}
}
