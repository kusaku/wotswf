...
public class ToolTipFortDivision extends ToolTipSpecial {
    ...
    override protected function redraw():void {
        ...
        topPosition = topPosition + (this._headerTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
        ...
        topPosition = topPosition + (this._descrTF.textHeight + Utils.instance.MARGIN_AFTER_SEPARATE | 0);
        if (_loc3_.params) {
            ...
            while (_loc7_ < _loc3_.params.length) {
                _loc6_.leftText = _loc6_.leftText + (Utils.instance.htmlWrapper(_loc3_.params[_loc7_][1], Utils.instance.COLOR_LABEL, 14, "$FieldFont") + "<br/>");
            ...
            hasIcon = !!_loc8_.hasIcons ? true : Boolean(hasIcon);
        ...
        if (_loc3_.warning != Values.EMPTY_STR) {
            ...
            topPosition = topPosition + (Utils.instance.MARGIN_AFTER_SEPARATE + 5);
            ...
            topPosition = topPosition + (this.warningTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
