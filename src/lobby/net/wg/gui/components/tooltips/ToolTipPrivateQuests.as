...
public class ToolTipPrivateQuests extends ToolTipSpecial {
    ...
    override protected function redraw():void {
        ...
        if (_loc8_.conditions && _loc8_.conditions != Values.EMPTY_STR) {
            ...
            topPosition = topPosition + (this.conditionTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
            _loc1_ = Utils.instance.createSeparate(content);
            _loc1_.y = topPosition;
            separators.push(_loc1_);
            topPosition = topPosition + Utils.instance.MARGIN_AFTER_SEPARATE;
        ...
        if (_loc8_.params && _loc8_.params.length > 0) {
            ...
            while (_loc4_ < _loc3_) {
                ...
                _loc9_.leftText = _loc9_.leftText + (Utils.instance.htmlWrapper(_loc8_.params[_loc4_][1], Utils.instance.COLOR_NUMBER, 12, "$TextFont") + "<br/>");
