...
public class SeparatorAsset extends Sprite implements ISeparatorAsset {
    ...
    public function SeparatorAsset() {
        ...
        this._actualWidth = Math.round(width);
        rotation = _loc1_;
    ...
    public function setCenterAsset(param1:String):void {
        ...
        if (_loc3_ is Sprite) {
            ...
            if (this._mode == SeparatorConstants.SCALE_MODE) {
                ...
                this._centerPartBitmapData = !!(_loc4_.getChildAt(0) as Bitmap) ? (_loc4_.getChildAt(0) as Bitmap).bitmapData : null;
            ...
            if (this._mode == SeparatorConstants.SCALE_MODE) {
                this._centerPart = new Sprite();
                _loc5_ = new Bitmap(_loc3_ as BitmapData);
                this._centerPart.addChild(_loc5_);
            }
            else if (this._mode == SeparatorConstants.TILE_MODE) {
                this._centerPartBitmapData = _loc3_ as BitmapData;
                this._centerPart = new Sprite();
            }
        }
        else {
    ...
    public function setSideAsset(param1:String):void {
        ...
        if (_loc3_ is Sprite) {
            ...
            this._leftPart.addChild(new Bitmap(_loc3_ as BitmapData));
            this._rightPart.addChild(new Bitmap(_loc3_ as BitmapData));
        }
        else {
    ...
    private function draw():void {
        ...
        var _loc1_:int = this._leftPart != null ? int(Math.round(this._leftPart.width)) : 0;
        var _loc2_:int = 0;
