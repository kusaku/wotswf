...
public class Cursor extends DroppingCursor implements ICursor, ICursorMeta {
    ...
    public function as_showCursor():void {
        this._visible = true;
    ...
    private function mouseDnDragHandler(param1:MouseEvent):void {
        ...
        if (isLeftButton(event)) {
            ...
            dragInfo.container.onStartDrag();
        }
    }
