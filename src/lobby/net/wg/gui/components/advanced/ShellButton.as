...
public class ShellButton extends CooldownSlot {
    ...
    public function ShellButton() {
        ...
        this._statesInactive = Vector.<String>(["inactive_"]);
        super();
        ...
        switch (this.tooltipType) {
            case TOOLTIPS_CONSTANTS.HANGAR_SHELL:
                ...
                if (StringUtils.isNotEmpty(_loc1_)) {
                    App.toolTipMgr.showSpecial(TOOLTIPS_CONSTANTS.HANGAR_SHELL, null, _loc1_, this.historicalBattleID);
                }
                break;
            ...
            case TOOLTIPS_CONSTANTS.COMPLEX:
                ...
                break;
            default:
                throw new ArgumentException("TooltipType value is invalid: " + this.tooltipType);
        }
    }
    ...
    override public function set isInactive(param1:Boolean):void {
        ...
        setState(!!_state ? _state : UP_STATE_NAME);
    }
