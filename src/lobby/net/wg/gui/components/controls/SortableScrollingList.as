...
public class SortableScrollingList extends ScrollingListEx {
    ...
    protected function applySorting(param1:Array):void {
        ...
        if (dataProvider) {
            ...
            _loc4_ = param1 != null ? int(param1.length) : 0;
            if (_loc4_ > 0 && _loc2_ && _loc4_ == _loc2_.length) {
                if (dataProvider is IDAAPISortable) {
                    _loc5_ = [];
                    _loc6_ = 0;
                    while (_loc6_ < _loc4_) {
                        _loc5_.push(!Boolean(_loc2_[_loc6_] ^ this._sortingTypes[param1[_loc6_]]));
                        _loc6_++;
                    }
                    (dataProvider as IDAAPISortable).DAAPIsortOn(param1, _loc5_);
                }
