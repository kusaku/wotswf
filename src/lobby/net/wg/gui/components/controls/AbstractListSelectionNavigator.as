...
public class AbstractListSelectionNavigator implements IDisposable {
    ...
    public function navigate(param1:int, param2:int):int {
        var _loc3_:int = param1;
        var _loc4_:int = this._dataProvider.length;
        while (!this.isSelectable(_loc3_)) {
    ...
    protected function isSelectable(param1:int):Boolean {
        throw new AbstractException("ListSelectionNavigator.isSelectable" + Errors.ABSTRACT_INVOKE);
    }
