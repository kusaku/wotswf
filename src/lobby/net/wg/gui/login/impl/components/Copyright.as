...
public class Copyright extends UIComponentEx {
    ...
    override protected function configUI():void {
        ...
        this.logotypes.addEventListener(LoginLogosEv.CHANGE, this.onLogoChangeHandler);
    ...
    override protected function onDispose():void {
        ...
        this.logotypes.removeEventListener(LoginLogosEv.CHANGE, this.onLogoChangeHandler);
        super.onDispose();
    }

    private function onLogoChangeHandler(param1:LoginLogosEv):void {
