            ...
            if (_loc7_[_loc8_]) {
                ...
                switch (_loc6_.type) {
                    ...
                    case SettingsConfigHelper.TYPE_SLIDER:
                        this.setupSlider(Slider(_loc7_[_loc8_]), _loc6_.current, _loc10_);
                        if (_loc6_.hasValue && _loc7_[_loc5_ + SettingsConfigHelper.TYPE_VALUE]) {
                            this.setupLabel(_loc7_[_loc5_ + SettingsConfigHelper.TYPE_VALUE], _loc6_.current);
                        }
                }
            }
