...
public class BoostersWindow extends BoostersWindowMeta implements IBoostersWindowMeta {
    ...
    override protected function configUI():void {
        ...
        this.noInfoCmp.addEventListener(FiltersEvent.RESET_FILTERS, this.onNoInfoCmpResetFiltersHandler);
    ...
    override protected function onDispose():void {
        ...
        this.noInfoCmp.removeEventListener(FiltersEvent.RESET_FILTERS, this.onNoInfoCmpResetFiltersHandler);
    ...
    override protected function draw():void {
        ...
        if (this._model && isInvalid(InvalidationType.DATA)) {
            ...
            this.tabs.dataProvider = new DataProvider(this._model.tabsLabels);
            this._currentTabId = this._model.tabIndex;
            this.tabs.selectedIndex = this._currentTabId;
    ...
    private function onTabIndexChangeHandler(param1:IndexEvent):void {
        if (this._currentTabId == param1.index) {
            return;
        }
        this._currentTabId = param1.index;
        requestBoostersArrayS(this._currentTabId);
    }
    ...
    private function onNoInfoCmpResetFiltersHandler(param1:FiltersEvent):void {
        onResetFiltersS();
    }
