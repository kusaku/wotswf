...
public class AbstractDataProvider implements INodesDataProvider {
    ...
    private var _nation:String = "ussr";
    ...
    protected static function findAndSetState(param1:Vector.<NodeData>, param2:Number, param3:Number, param4:Number):Boolean {
        ...
        if (_loc6_ != null) {
            _loc5_ = Boolean((_loc6_.state & param3) != (param4 & param3));
            if (!_loc5_ && param3 == NODE_STATE_FLAGS.IN_INVENTORY) {
                _loc5_ = Boolean((_loc6_.state & NODE_STATE_FLAGS.VEHICLE_IN_RENT) != (param4 & NODE_STATE_FLAGS.VEHICLE_IN_RENT));
            }
            _loc6_.state = param4;
        }
        return _loc5_;
