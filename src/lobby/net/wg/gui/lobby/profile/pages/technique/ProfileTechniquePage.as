...
public class ProfileTechniquePage extends ProfileTechniquePageMeta implements IProfileTechniquePageMeta {
    ...
    private var _selVehicleCompDescr:int = -1;
    ...
    override protected function applyInitData():void {
        ...
        App.utils.asserter.assertNotNull(_loc1_, "techniquePageInitVO " + Errors.CANT_NULL);
    ...
    override protected function draw():void {
        ...
        if (isInvalid(LAYOUT_INVALID)) {
            ...
            if (_loc5_ < 0) {
                this.checkBoxExistence.x = this.checkBoxExistence.x + _loc5_;
            }
        }
        if (isInvalid(SEL_ITEM_INDEX_INVALID)) {
            listComponent.selectVehicleById(this._selVehicleCompDescr);
        }
    }
