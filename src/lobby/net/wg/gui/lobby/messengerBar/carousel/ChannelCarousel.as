...
public class ChannelCarousel extends ChannelCarouselMeta implements IChannelCarouselMeta {
    ...
    override protected function configUI():void {
        ...
        addEventListener(ChannelListEvent.OPEN_CHANNEL, this.onChannelOpenClickHandler, false, 0, true);
        addEventListener(ChannelListEvent.CLOSE_CHANNEL, this.onChannelCloseClickHandler, false, 0, true);
        ...
        _loc1_.addEventListener(MessengerBarEvent.PIN_CAROUSEL_WINDOW, this.onAppStagePinCarouselWindowHandler);
        _loc1_.addEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_FOCUS_IN, this.onAppStageChannelWindowFocusInHandler);
        _loc1_.addEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_FOCUS_OUT, this.onAppStageChannelWindowFocusOutHandler);
        _loc1_.addEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_SHOW, this.onAppStageChannelWindowShowHandler);
        _loc1_.addEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_HIDE, this.onAppStageChannelWindowHideHandler);
    }
    ...
    override protected function onDispose():void {
        ...
        removeEventListener(ChannelListEvent.OPEN_CHANNEL, this.onChannelOpenClickHandler);
        removeEventListener(ChannelListEvent.CLOSE_CHANNEL, this.onChannelCloseClickHandler);
        var _loc1_:Stage = App.stage;
        _loc1_.removeEventListener(MessengerBarEvent.PIN_CAROUSEL_WINDOW, this.onAppStagePinCarouselWindowHandler);
        _loc1_.removeEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_FOCUS_IN, this.onAppStageChannelWindowFocusInHandler);
        _loc1_.removeEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_FOCUS_OUT, this.onAppStageChannelWindowFocusOutHandler);
        _loc1_.removeEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_SHOW, this.onAppStageChannelWindowShowHandler);
        _loc1_.removeEventListener(MessengerBarChannelCarouselEvent.CHANNEL_WINDOW_HIDE, this.onAppStageChannelWindowHideHandler);
    ...
    private function isScrollNeeded(param1:int):Boolean {
        ...
        var _loc3_:uint = !!_loc2_ ? uint(_loc2_.length) : uint(0);
    ...
    private function onChannelOpenClickHandler(param1:ChannelListEvent):void {
        param1.stopImmediatePropagation();
        channelOpenClickS(param1.clientID);
    }

    private function onChannelCloseClickHandler(param1:ChannelListEvent):void {
        param1.stopImmediatePropagation();
