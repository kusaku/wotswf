...
public class FlexibleTileList extends TileList {
    ...
    override protected function calculateRendererTotal(param1:Number, param2:Number):uint {
        ...
        _autoColumnWidth = getAvailableItemWidth(!!_dataProvider ? int(_dataProvider.length) : 0, this.minRendererWidth, this.maxRendererWidth, _loc3_);
    ...
    override protected function drawLayout():void {
        ...
        var _loc1_:uint = !!_renderers ? uint(_renderers.length) : uint(0);
