...
public class ModuleEffects extends UIComponent {
    ...
    private function getEffectParams(param1:Object):String {
        ...
        if (param1.effectOnUse && param1.effectOnUse != Values.EMPTY_STR && param1.effectOnUse != undefined) {
            _loc2_ = _loc2_ + this.getEquipmentUsageBlock(_loc3_.makeString(TOOLTIPS.EQUIPMENT_ONUSE), _loc3_.makeString(param1.effectOnUse), MARGIN_BETWEEN_EFFECTS);
        }
        if (param1.effectAlways != Values.EMPTY_STR && param1.effectAlways != Values.EMPTY_STR && param1.effectAlways != undefined) {
            _loc2_ = _loc2_ + this.getEquipmentUsageBlock(_loc3_.makeString(TOOLTIPS.EQUIPMENT_ALWAYS), _loc3_.makeString(param1.effectAlways), MARGIN_BETWEEN_EFFECTS);
        }
        ...
        if (param1.effectRestriction != Values.EMPTY_STR && param1.effectRestriction != Values.EMPTY_STR && param1.effectRestriction != undefined) {
            _loc2_ = _loc2_ + (TAG_BR + Utils.instance.htmlWrapper(Values.EMPTY_STR, COLOR_EFFECT, SIZE_EFFECT, FIELD_FONT) + TAG_BR + Utils.instance.htmlWrapper(App.utils.locale.makeString(param1.effectRestriction), COLOR_EFFECT, SIZE_EFFECT, FIELD_FONT));
        }
        return _loc2_;
    }
    ...
    private function getEquipmentUsageBlock(param1:String, param2:String, param3:int = 20):String {
        ...
        var _loc4_:String = TAG_BR + param1 + TAG_BR + param2;
        return _loc4_;
    }
}
}
