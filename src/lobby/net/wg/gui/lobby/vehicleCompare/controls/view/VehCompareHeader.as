...
public class VehCompareHeader extends UIComponentEx implements IVehCompareViewHeader {
    ...
    private static const INFO_ICON_GAP:int = 8;
    ...
    override protected function configUI():void {
        super.configUI();
        this.infoIcon.tooltip = VEH_COMPARE.VEHICLECOMPAREVIEW_TOOLTIPS_INFO;
    ...
    private function layout():void {
        ...
        this.infoIcon.x = this.titleTf.x - this.infoIcon.width - INFO_ICON_GAP;
    }
