...
public class RetrainCrewWindow extends RetrainCrewWindowMeta implements IRetrainCrewWindowMeta {
    ...
    private var _initCrewVO:RetrainCrewBlockVO;

    private var _initCrewOperationVO:RetrainCrewOperationVO;
    ...
    override public function setWindow(param1:IWindow):void {
        ...
        _loc4_.bottom = _loc4_.bottom + (_loc3_ + CANCEL_BTN_ADDITIONAL_HEIGHT);
    ...
    override protected function draw():void {
        ...
        if (this._initCrewVO && isInvalid(CREW_BLOCK_INVALID)) {
            this.rolesGroup.dataProvider = this._initCrewVO.crewInfoVO;
            this.txtCrewMembers.htmlText = this._initCrewVO.crewMembersText;
            if (this._initCrewVO.priceInfo) {
                _loc2_ = App.utils.locale;
                _loc3_ = this._initCrewVO.priceInfo;
                ...
                if (this.btnsGroup.selectedId != -1) {
                    if (_loc3_.isGold) {
                        ...
                        _loc5_ = this._initCrewOperationVO.tankmanCost[this.btnsGroup.selectedId].gold;
                    }
                    else {
                        _loc7_ = this.btnsGroup.operationData.credits >= _loc6_;
                        _loc5_ = this._initCrewOperationVO.tankmanCost[this.btnsGroup.selectedId].credits;
                    }
                    this.summIconText.text = _loc4_ + SUMM_PATTERN + _loc2_.integer(_loc5_);
                    this.result.valueTextColor = !!_loc7_ ? uint(IconsTypes.getTextColor(this.resultIcon.icon)) : uint(NOT_ENOUGH_MONEY_COLOR);
    ...
    override protected function onDispose():void {
        ...
        this._initCrewVO = null;
        this._initVehicleVO = null;
        this._initCrewOperationVO = null;
        super.onDispose();
    }

    override protected function setCrewOperationData(param1:RetrainCrewOperationVO):void {
        this._initCrewOperationVO = param1;
        this.btnsGroup.operationData = this._initCrewOperationVO;
    }

    override protected function setAllCrewData(param1:RetrainCrewBlockVOBase):void {
        this.btnsGroup.crewInfo = param1.crewInfoVO;
    }

    override protected function setCrewData(param1:RetrainCrewBlockVO):void {
        this._initCrewVO = param1;
    ...
    override protected function setVehicleData(param1:RetrainVehicleBlockVO):void {
        ...
        this.btnsGroup.currentVehicleType = this._initVehicleVO.vType;
        this.btnsGroup.currentVehicleIntCD = this._initVehicleVO.vIntCD;
