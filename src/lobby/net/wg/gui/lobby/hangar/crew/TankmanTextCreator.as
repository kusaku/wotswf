...
public class TankmanTextCreator {
    ...
    public function TankmanTextCreator(param1:TankmanVO, param2:TankmanRoleVO) {
        super();
        this._nameTF = param1.firstName + " " + param1.lastName;
        this._rank = param1.rank;
        this._roleHtml = param1.role;
        var _loc3_:* = param1.specializationLevel + "%";
        ...
        if (isNaN(param1.tankmanID)) {
            ...
            this._roleHtml = this._roleHtml + (", " + _loc4_ + " " + param1.vehicleType);
        }
        else if (param2.tankType != param1.tankType) {
            this._levelSpecializationMainHtml = " <font color=\'" + DEBUFF + "\'>" + _loc3_ + "</font>";
            this._roleHtml = this._roleHtml + (", <font color=\'" + DEBUFF + "\'>" + _loc4_ + " " + param1.vehicleType + "</font>");
        }
            ...
            this._roleHtml = this._roleHtml + (", " + _loc4_ + " <font color=\'" + DEBUFF + "\'> " + param1.vehicleType + "</font>");
        }
        else {
