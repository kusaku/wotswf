...
public class Crew extends CrewMeta implements ICrew {
    ...
    override protected function configUI():void {
        super.configUI();
        mouseEnabled = false;
        addEventListener(CrewEvent.OPEN_PERSONAL_CASE, this.onOpenPersonalCaseHandler);
    ...
    override protected function draw():void {
        if (isInvalid(INVALIDATE_ENABLE)) {
            ...
            this.list.mouseEnabled = enabled;
    ...
    private function updateDogItemPosition():void {
        ...
        if (this.list.dataProvider) {
            _loc1_ = !!this._crewDogItem ? Number(this.list.dataProvider.length + 1) : Number(this.list.dataProvider.length);
    ...
    private function onOpenPersonalCaseHandler(param1:CrewEvent):void {
