...
public class ClanViewWithVariableContent extends ClanProfileBaseView {
    ...
    protected function updateContent():void {
        ...
        if (this._content) {
            this.container.removeChild(this._content);
            unregisterFlashComponentS(this.getAlias(this._contentLinkage));
            this._content = null;
        }
        ...
        registerFlashComponentS(this._content, this.getAlias(this._contentLinkage));
    }

    private function getAlias(param1:String):String {
