...
public class HeaderButtonContentItem extends UIComponent implements IHeaderButtonContentItem {
    ...
    public function parentButtonClicked():void {
    }
    ...
    public function onPopoverOpen():void {
        DebugUtils.LOG_DEBUG("HeaderButtonContentItem.onPopoverOpen must be overridden");
    }

    public function onPopoverClose():void {
        DebugUtils.LOG_DEBUG("HeaderButtonContentItem.onPopoverClose must be overridden");
    }
