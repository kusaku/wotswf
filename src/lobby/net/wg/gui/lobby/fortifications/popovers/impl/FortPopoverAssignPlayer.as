...
public class FortPopoverAssignPlayer extends UIComponent {
    ...
    private static const FOOTHOLD_BTN_PNG:String = "foothold.png";
    ...
    private function onRollOverHandler(param1:MouseEvent):void {
        var _loc2_:String = App.toolTipMgr.getNewFormatter().addHeader(App.utils.locale.makeString(TOOLTIPS.FORTIFICATION_POPOVER_FIXEDPLAYERSBTN_HEADER)).addBody(App.utils.locale.makeString(TOOLTIPS.FORTIFICATION_POPOVER_FIXEDPLAYERSBTN_BODY, {
