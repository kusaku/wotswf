...
public class AnimatedIcon extends UIComponentEx {
    ...
    private static const ICON_FADE_IN_DELAY:Number = 200;

    private static const OVERLAY_FADE_IN_DELAY:Number = 200;

    private static const OVERLAY_FADE_OUT_DURATION:Number = 500;

    private static const OVERLAY_FADE_OUT_ALPHA:Number = 0.25;
