...
public class OrderPopoverVO extends DAAPIDataClass {
    ...
    private var _showDetailsBtn:Boolean;
    ...
    public function get showDetailsBtn():Boolean {
        return this._showDetailsBtn;
    }

    public function set showDetailsBtn(param1:Boolean):void {
        this._showDetailsBtn = param1;
    }
}
}
