package net.wg.gui.lobby.fortifications.data.battleRoom.clanBattle
{
   ...
   public class ClanBattleRenderListVO extends DAAPIDataClass implements IRallyListItemVO
   {
      ...
      public var timer:net.wg.gui.lobby.fortifications.data.battleRoom.clanBattle.ClanBattleTimerVO;
      ...
      override protected function onDataWrite(param1:String, param2:Object) : Boolean
      {
         if(param1 == TIMER_FIELD && param2 != null && param2["timer"] != null)
         {
            ...
            this.timer = new net.wg.gui.lobby.fortifications.data.battleRoom.clanBattle.ClanBattleTimerVO(param2["timer"]);
            return false;
         }
