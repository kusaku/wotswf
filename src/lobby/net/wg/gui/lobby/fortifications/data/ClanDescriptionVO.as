...
public class ClanDescriptionVO extends DAAPIDataClass {
    ...
    private static const FIELD_DIRECTIONS:String = "directions";

    private static const FIELD_DIVISION_ICON:String = "divisionIcon";

    private static const KEYS_CLAN_DESCR_ITEM_VO:Vector.<String> = new <String>["clanBattles", "clanWins", "clanAvgDefres"];
    ...
    public var divisionIcon:FortTankIconVO = null;
    ...
    override protected function onDataWrite(param1:String, param2:Object):Boolean {
        ...
        switch (param1) {
            case FIELD_DIRECTIONS:
                ...
                return false;
            case FIELD_DIVISION_ICON:
                this.divisionIcon = new FortTankIconVO(param2);
                return false;
            default:
                return true;
        }
