...
public class DismissTankmanDialog extends DismissTankmanDialogMeta implements IDismissTankmanDialogMeta {
    ...
    private const NONE_PROTECTED_MODE_PADDING:int = -6;

    private const PROTECTED_MODE_PADDING:int = 15;
    ...
    override protected function onPopulate():void {
        ...
        _loc1_.right = 14;
        App.utils.scheduler.scheduleOnNextFrame(this.updateFocus, this.inputChecker.getComponentForFocus());
    }
    ...
    public function as_tankMan(param1:Object):void {
        ...
        if (this.model.roleLevel < 100 && this.model.lastSkill == null && this.model.hasNewSkill == false) {
            ...
            App.utils.scheduler.scheduleOnNextFrame(this.updateFocus, secondBtn);
        }
        else {
    ...
    private function setData():void {
        ...
        this.mainBlock.setSkills(!!this.protectedState ? int(this.model.skillsCount) : -1, this.model.preLastSkill, this.model.lastSkill, this.model.lastSkillLevel, this.model.hasNewSkill, this.model.newSkillsCount, this.model.lastNewSkillLevel);
