    ...
    override protected function draw():void {
        ...
        if (isInvalid(InvalidationType.DATA)) {
            if (data) {
                ...
                App.utils.commons.formatPlayerName(this.textOwner, App.utils.commons.getUserProps(this._dataVO.creatorName, this._dataVO.creatorClan, this._dataVO.creatorRegion, this._dataVO.creatorIgrType));
