...
public class RecruitWindow extends RecruitWindowMeta implements IRecruitWindowMeta {
    ...
    override protected function draw():void {
        ...
        if (isInvalid(InvalidationType.DATA) && this._data) {
            ...
            if (this._data.gold < this._data.academyUpgradePrice) {
            ...
            if (this._data.credits < this._data.schoolUpgradePrice) {
    ...
    public function as_setCreditsChanged(param1:Number):void {
        this.btnScool.enabled = param1 > this._data.schoolUpgradePrice;
    }
