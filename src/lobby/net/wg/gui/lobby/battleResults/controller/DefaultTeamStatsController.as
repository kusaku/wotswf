...
public class DefaultTeamStatsController extends TeamStatsControllerAbstract {
    ...
    private var _victoryScore1:VictoryScorePanel;

    private var _victoryScore2:VictoryScorePanel;
    ...
    override public function dispose():void {
        ...
        this._csAlly = null;
        this._csEnemy = null;
        this._victoryScore1 = null;
        this._victoryScore2 = null;
        super.dispose();
    }
    ...
    override public function update(param1:BattleResultsVO):void {
        ...
        this.setupVictoryScore(param1.common.victoryScore, this._victoryScore1, this._victoryScore2);
    ...
    override protected function getColumnIds():Vector.<String> {
        return new <String>[ColumnConstants.SQUAD, ColumnConstants.PLAYER, ColumnConstants.TANK, ColumnConstants.DAMAGE, ColumnConstants.FRAG, ColumnConstants.XP, ColumnConstants.MEDAL];
    }
    ...
    public function handleListIndexChange(param1:ScrollingListEx, param2:TeamMemberStatsView, param3:TeamMemberStatsView, param4:BattleResultsVO):void {
    ...
    public function setVictoryScore(param1:VictoryScorePanel, param2:VictoryScorePanel):void {
        this._victoryScore1 = param1;
        this._victoryScore2 = param2;
    }
    ...
    protected function setupVictoryScore(param1:Vector.<VictoryPanelVO>, param2:VictoryScorePanel, param3:VictoryScorePanel):void {
    ...
    private function sortList(param1:TeamStatsList, param2:ColumnData, param3:Number):void {
        ...
        var _loc7_:Array = DataProvider(_loc6_).slice();
        _loc7_.sortOn(param2.sortingKeys, param3);
        if (_loc6_ != null) {
            _loc6_.cleanUp();
        }
        param1.dataProvider = new DataProvider(_loc7_);
        if (_loc4_ >= 0) {
