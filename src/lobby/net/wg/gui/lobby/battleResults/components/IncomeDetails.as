...
public class IncomeDetails extends IncomeDetailsBase {
    ...
    override protected function setColumnsData(param1:DetailedStatsItemVO):void {
        this.col1.htmlText = this.col1.htmlText + param1.col1;
        this.col2.htmlText = this.col2.htmlText + param1.col2;
        this.col3.htmlText = this.col3.htmlText + param1.col3;
        this.col4.htmlText = this.col4.htmlText + param1.col4;
    }
}
}
