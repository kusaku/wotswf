    ...
    override protected function draw():void {
        ...
        if (isInvalid(InvalidationType.DATA)) {
            ...
            if (this._headerVO) {
                ...
                this.removeTextFieldsListeners();
                this.summArmorTF.htmlText = this.summCritsTF.htmlText = this.summDamageTF.htmlText = this.summAssistTF.htmlText = this.summKillTF.htmlText = this.summSpottedTF.htmlText = Values.EMPTY_STR;
            }
        }
    }
