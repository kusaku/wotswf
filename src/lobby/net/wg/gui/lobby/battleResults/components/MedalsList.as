...
public class MedalsList extends CoreListEx {
    ...
    private static function isDisplaySpecial(param1:Object):Boolean {
        ...
        var _loc3_:* = param1[SPECIAL_ICON_PROP_NAME] != Values.EMPTY_STR;
    ...
    override protected function drawLayout():void {
        ...
        for each(_loc5_ in _renderers) {
            ...
            _loc3_ = _loc3_ + (_loc5_.width + _loc1_ + _loc4_);
        }
        ...
        if (this._align == ALIGN_RIGHT) {
            _loc7_ = int(width - (_loc2_ > 0 ? _loc5_.width : 0));
        }
        ...
        while (_loc8_ < _loc2_) {
            ...
            _loc7_ = int(_loc7_ + (this._align == ALIGN_RIGHT ? -_loc9_ : _loc9_));
            if (!_loc6_) {
                _loc5_.validateNow();
            }
            _loc8_++;
    ...
    private function getPersonalPadding(param1:IListItemRenderer):int {
        ...
        return _loc2_ && this._paddings.hasOwnProperty(_loc2_.type) ? int(this._paddings[_loc2_.type]) : 0;
    }
