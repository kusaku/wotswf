...
public class AchievementItemVO extends DAAPIDataClass {
    ...
    override public function isEquals(param1:DAAPIDataClass):Boolean {
        ...
        return this.name == _loc2_.name && this.block == _loc2_.block && this.section == _loc2_.section && this.type == _loc2_.type && this.isInDossier == _loc2_.isInDossier && this.localizedValue == _loc2_.localizedValue && _loc3_ && this.value == _loc2_.value && this.iconAlpha == _loc2_.iconAlpha && this.dossierType == _loc2_.dossierType && this.dossierCompDescr == _loc2_.dossierCompDescr;
    }
}
}
