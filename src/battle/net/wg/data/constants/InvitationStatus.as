...
public class InvitationStatus {
    ...
    public static function isForbiddenByReceiver(param1:uint):Boolean {
        return (param1 & InvitationStatus.FORBIDDEN_BY_RECEIVER) > 0;
    }

    public static function isForbiddenBySender(param1:uint):Boolean {
        return (param1 & InvitationStatus.FORBIDDEN_BY_SENDER) > 0;
    }
