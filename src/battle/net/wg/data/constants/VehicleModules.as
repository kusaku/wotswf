...
public class VehicleModules {
    ...
    public static const MODULES_LIST:Vector.<String> = new <String>[LEFT_TRACK, RIGHT_TRACK, RADIO, SURVEYING_DEVICE, GUN, TURRET_ROTATOR, AMMO_BAY, FUEL_TANK, ENGINE, CHASSIS];
