package net.wg.gui.settings.evnts {
...
public class SettingsSubVewEvent extends Event {
    ...
    public function SettingsSubVewEvent(param1:String, param2:String, param3:String = "", param4:* = null, param5:String = "", param6:Boolean = false, param7:Boolean = false) {
