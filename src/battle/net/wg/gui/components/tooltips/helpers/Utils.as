...
public class Utils {
    ...
    public const allowStatuses:Array = [STATUS_ADDITIONAL, STATUS_RENTED, STATUS_CRITICAL, STATUS_WARNING, STATUS_INFO];
    ...
    public function addEmptyBlock(param1:ToolTipBlockVO):void {
        param1.leftText = param1.leftText + (Utils.instance.htmlWrapper(" ", this.COLOR_NUMBER, 12, "$TextFont") + "<br/>");
    ...
    public function createBlock(param1:ToolTipBlockVO, param2:Number):ToolTipBlockResultVO {
        ...
        if (param1.header) {
            ...
            param1.startYPos = param1.startYPos + (_loc21_.textHeight + this.MARGIN_AFTER_SUBHEADER ^ 0);
        }
    ...
    public function htmlWrapper(param1:String, param2:String = "#ffffff", param3:Number = 12, param4:String = "$TextFont"):String {
        var _loc5_:String = "";
        _loc5_ = _loc5_ + (param4 == "" ? "" : " face=\"" + param4 + "\"");
        _loc5_ = _loc5_ + (param2 == "" ? "" : " color=\"" + param2 + "\"");
        _loc5_ = _loc5_ + (!param3 ? "" : " size=\"" + param3 + "\"");
        param1 = "<font" + _loc5_ + ">" + param1 + "</font>";
        return param1;
    }
}
}
