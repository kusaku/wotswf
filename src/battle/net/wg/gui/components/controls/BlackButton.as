...
public class BlackButton extends SoundButtonEx {
    ...
    override protected function updateDynamicSizeByText():void {
        ...
        if (textField != null && StringUtils.isNotEmpty(textField.text)) {
            _loc1_ = textField.textWidth + this.image.width + (_paddingHorizontal << 1) ^ 0;
            if (this.width != _loc1_) {
                this.width = _loc1_;
    ...
    private function updatePositions():void {
        ...
        this.toggleGlow.scaleX = _loc1_;
        this.toggleGlow.scaleY = _loc2_;
        ...
        if (_loc5_) {
            ...
            if (_loc6_) {
                _loc4_ = _loc4_ - (this.image.width + this._iconOffsetText >> 1);
            }
        }
        else if (_loc6_) {
        ...
        this.toggleIndicator.x = (hitMc.width - this.toggleIndicator.width >> 1) * _loc1_;
    ...
    private function updateIndicatorSelection():void {
        if (this._toggleEnable) {
            ...
            this.toggleGlow.alpha = !!selected ? Number(1) : Number(0);
