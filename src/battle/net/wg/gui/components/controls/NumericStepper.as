...
public class NumericStepper extends scaleform.clik.controls.NumericStepper {
    ...
    private function initItems():void {
        ...
        textField.width = textField.width + (_loc3_ - this._originalWidth);
    ...
    private function calcDigitsCount():void {
        ...
        while (_loc1_ < this._digits) {
            this._digitsStr = this._digitsStr + "0";
            _loc1_++;
        }
    }
    ...
    private function checkLockValue(param1:Number):Number {
        ...
        var _loc2_:Number = Math.max(_minimum, Math.min(_maximum, stepSize * Math.round(param1 / stepSize)));
        return _loc2_;
    }
    ...
    private function getEnabledForBtn(param1:Button):Boolean {
        ...
        if (this.isUseLoop) {
            ...
            _loc2_ = param1 == prevBtn ? value != minimum : value != maximum;
        }
    ...
    private function checkTextColor(param1:Number, param2:String):void {
        var _loc3_:String = !!this.states ? this.states.currentLabel : currentLabel;
