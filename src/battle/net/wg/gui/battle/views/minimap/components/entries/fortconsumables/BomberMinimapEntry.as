...
public class BomberMinimapEntry extends BattleUIComponent {
    ...
    override protected function configUI():void {
        super.configUI();
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, FortConsumablesMinimapEntryConst.BOMBER_ATLAS_ITEM_NAME, this.atlasPlaceholder.graphics, "", true);
    }
