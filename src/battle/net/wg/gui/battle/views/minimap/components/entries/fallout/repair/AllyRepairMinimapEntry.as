...
public class AllyRepairMinimapEntry extends BattleUIComponent {
    ...
    override protected function configUI():void {
        super.configUI();
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ALLY_REPAIR_ACTIVE_ATLAS_ITEM_NAME, this.active.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ALLY_REPAIR_COOLDOWN_ATLAS_ITEM_NAME, this.cooldown.graphics, "", true);
