...
public class FlagMinimapEntry extends BattleUIComponent {
    ...
    override protected function configUI():void {
        super.configUI();
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, FlagMinimapEntryConst.FLAG_COOLDOWN_ATLAS_ITEM_NAME, this.cooldown.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, FlagMinimapEntryConst.FLAG_NEUTRAL_ATLAS_ITEM_NAME, this.neutral.graphics, "", true);
