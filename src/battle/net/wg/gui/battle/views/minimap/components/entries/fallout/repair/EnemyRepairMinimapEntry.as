...
public class EnemyRepairMinimapEntry extends BattleUIComponent {
    ...
    override protected function configUI():void {
        super.configUI();
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ENEMY_REPAIR_ACTIVE_ATLAS_ITEM_NAME, this.active.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ENEMY_REPAIR_ACTIVE_PURPLE_ATLAS_ITEM_NAME, this.activePurple.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ENEMY_REPAIR_COOLDOWN_ATLAS_ITEM_NAME, this.cooldown.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, RepairMinimapEntryConst.ENEMY_REPAIR_COOLDOWN_PURPLE_ATLAS_ITEM_NAME, this.cooldownPurple.graphics, "", true);
