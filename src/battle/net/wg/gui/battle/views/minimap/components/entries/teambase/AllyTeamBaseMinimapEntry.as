...
public class AllyTeamBaseMinimapEntry extends BattleUIComponent {
    ...
    public function setPointNumber(param1:int):void {
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, TeamBaseMinimapEntryConst.ALLY_TEAM_BASE_ATLAS_ITEM_NAME + "_" + MinimapColorConst.GREEN + "_" + param1, this.atlasPlaceholder.graphics, "", true);
    }
