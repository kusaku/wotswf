...
public class EnemyTeamSpawnMinimapEntry extends BattleUIComponent {
    ...
    private function drawEntry():void {
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, TeamBaseMinimapEntryConst.ENEMY_TEAM_SPAWN_ATLAS_ITEM_NAME + "_" + App.colorSchemeMgr.getScheme(MinimapColorConst.TEAM_SPAWN_BASE_RED).aliasColor + "_" + this._pointNumber, this.atlasPlaceholder.graphics, "", true);
    }
