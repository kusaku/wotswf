...
public class AllyAbsorptionFlagMinimapEntry extends BattleUIComponent {
    ...
    override protected function configUI():void {
        super.configUI();
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, AbsorptionFlagEntryConst.ALLY_ABSORPTION_FLAG_ATLAS_ITEM_NAME, this.absorptionFlag.graphics, "", true);
        this._atlasManager.drawGraphics(AtlasConstants.BATTLE_ATLAS, AbsorptionFlagEntryConst.ALLY_ABSORPTION_FLAG_ANIM_ATLAS_ITEM_NAME, this.capturePointAnim.animItem.graphics, "", true);
