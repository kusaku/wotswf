...
public class VehicleMessage extends EventDispatcher implements IMessage {
    ...
    private function updateTextField():void {
        ...
        switch (this._textField.defaultTextFormat.align) {
            ...
            case TextFormatAlign.JUSTIFY:
                this._tfOffset.x = this._tfOffset.x + (_loc1_ - this._textField.width >> 1);
                break;
            case TextFormatAlign.RIGHT:
                this._tfOffset.x = this._tfOffset.x + (_loc1_ - this._textField.width);
        }
    }
    ...
    public function get numLines():int {
        return !!this._used ? int(this._textField.numLines) : 1;
    }
