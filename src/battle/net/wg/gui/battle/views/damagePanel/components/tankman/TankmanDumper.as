...
public class TankmanDumper implements IDisposable {
    ...
    public function getItems():Vector.<IDamagePanelClickableItem> {
        ...
        var _loc1_:Vector.<IDamagePanelClickableItem> = new <IDamagePanelClickableItem>[this.commander, this.driver, this.radioman1, this.radioman2, this.gunner1, this.gunner2, this.loader1, this.loader2];
