...
public class TankmanAssets implements IDamagePanelClickableItem {
    ...
    public function TankmanAssets(param1:String, param2:String, param3:String, param4:int, param5:int) {
        var _loc10_:int = 0;
        super();
        this._name = param1;
        var _loc6_:Class = App.utils.classFactory.getClass(param2);
        var _loc7_:Class = App.utils.classFactory.getClass(param3);
        this._normal = new Bitmap(new _loc6_());
        ...
        var _loc8_:int = (DamagePanel.PANEL_WIDTH - param5 * X_STEP >> 1) + X_OFFSET;
        var _loc9_:int = _loc8_ + X_STEP * param4;
        _loc10_ = Y_POS;
        this.state = BATTLE_ITEM_STATES.NORMAL;
        this._tankmanHit.x = this._critical.x = this._normal.x = _loc9_;
        this._tankmanHit.y = this._critical.y = this._normal.y = _loc10_;
