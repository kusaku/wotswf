...
public class PlayersPanelDynamicSquad extends BattleUIComponent implements IClickButtonHandler {
    ...
    public function setCurrentSquad(param1:Boolean, param2:int):void {
        ...
        if (param2 > 0) {
            this.squadIcon.imageName = BattleAtlasItem.getSquadIconName(param1, param2);
        }
    ...
    override protected function configUI():void {
        ...
        this.inviteDisabled.imageName = BattleAtlasItem.SQUAD_INVITE_DISABLED;
        this.inviteReceivedFromSquad.visible = false;
        this.inviteReceivedFromSquad.imageName = BattleAtlasItem.SQUAD_INVITE_RECEIVED_FROM_SQUAD;
        this.inviteReceived.visible = false;
        this.inviteReceived.imageName = BattleAtlasItem.SQUAD_INVITE_RECEIVED;
        this.inviteSent.visible = false;
        this.inviteSent.imageName = BattleAtlasItem.SQUAD_INVITE_SENT;
        this.noSound.visible = false;
        this.noSound.imageName = BattleAtlasItem.SQUAD_NO_SOUND;
