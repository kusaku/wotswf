...
public class RendererContainer extends Sprite implements IDisposable {
    ...
    public var vehicleLevelIconsAlly:Vector.<BattleAtlasSprite>;
    ...
    public function RendererContainer() {
        super();
