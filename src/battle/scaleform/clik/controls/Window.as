...
public class Window extends UIComponent {
    ...
    protected function loadSource():void {
        ...
        if (this._src != "") {
            ...
            _loc1_ = App.utils.classFactory.getClass(this._src) as Class;
            if (_loc1_) {
                this._content = DisplayObject(App.utils.classFactory.getComponent(this._src, DisplayObject));
